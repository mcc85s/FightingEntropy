...
$Ctrl.AddFile("Impressions Full",       "02/22/2023","12:52:00","01:54:10","https://drive.google.com/file/d/1CY1eKZhcXzA8cDKDxxSalgTGdq9hAZG1")

# Parties
$File = $Ctrl.Get(0)
$File.AddParty("Michael C. Cook Sr.")

$File = $Ctrl.Get(1)
$File.AddParty("Michael C. Cook Sr.")
$File.AddParty("Captain Jeffrey Brown")
$File.AddParty("Super Civil Officer Clerk Lady 5000")
$File.AddParty("Unspecified Sidekick Dude")
