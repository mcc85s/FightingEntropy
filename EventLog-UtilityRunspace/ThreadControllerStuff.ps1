...
While (!$Test)
{
    ...
    "----- ------           --------";
    $Slot.Thread | % { "{0:d5} {1}        {2}" -f $_.Index, $_.Status, $_.Complete}) -Prompt "Please wait..."
...
Write-Theme "Sorting (Events by TimeCreated) [~] (Logs/Output), Elapsed: [$($Sync.Control.Status.Elapsed())]" @(6,14,15,0)
...
While (!$Test)
{
    ...
    "Index Status           Complete",
    "----- ------           --------";
    $Slot.Thread | % { "{0:d5} {1}        {2}" -f $_.Index, $_.Status, $_.Complete}) -Prompt "Complete: [$Percent]"
    Start-Sleep 5
    If (!$Test)
    {
        $Test = $Slot.Query()
