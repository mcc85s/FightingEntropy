// 07/27/2026 Roslyn Compiler Controller (Windows/Linux)
...
namespace Compiler
{
    ...
    public class Controller
    {
        ...
        public Controller() : this(DotNetVersion.Net8) { }
        ...
        public void FindCompiler()
        {
            ...
            {
                string[] roots = new[]{ "/usr/share/dotnet/sdk", "/opt/dotnet/sdk" };
            ...
            {
                string root    = Path.Combine(Environment.GetEnvironmentVariable("ProgramFiles"), "dotnet", "sdk");
            ...
            compiler           = sdks.Select(x => Path.Combine(x, "Roslyn","bincore","csc.dll")).FirstOrDefault(System.IO.File.Exists);
        ...
        public string RuntimePath()
        {
            if (Platform == Platform.Windows)
                return Path.Combine(Environment.GetEnvironmentVariable("ProgramFiles"), "dotnet", "shared", "Microsoft.NETCore.App");
