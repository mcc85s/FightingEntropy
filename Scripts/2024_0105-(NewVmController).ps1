...
Class NewVmControllerNodeScriptBlockController
{
    ...
    {
        $This.Output += $This.NewVmControllerNodeScriptBlockItem($This.Output.Count,$Phase,$Name,$DisplayName,$Content)
...
Class NewVmControllerNodeWindows : NewVmControllerNodeObject
{
    ...
    SetTimeZone()
    {
        ...
        $This.Script.Add(1,"SetTimeZone","Set time zone",@('Set-Timezone -Name "{0}" -Verbose' -f (Get-Timezone).Id))
    }
    SetIcmpFirewall()
    {
        ...
        $This.Script.Add(2,"SetIcmpFirewall","Enable IcmpV4",@($Content))
    }
    SetWinRm()
    {
        # [Phase 3] Set WinRM (Config)
        $This.Script.Add(3,"SetWinRm","Set (WinRM Config/Self-Signed Certificate/HTTPS Listener)",@(
    ...
    SetWinRmFirewall()
    {
        ...
        $This.Script.Add(4,"SetWinRmFirewall",'Set WinRm Firewall',@(
        '$Item           = Get-ItemProperty "HKLM:\Software\Policies\Secure Digits Plus LLC\ComputerInfo"';
    ...
    SetRemoteDesktop()
    {
        ...
        $This.Script.Add(5,"SetRemoteDesktop",'Set Remote Desktop',@(
    ...
    InstallFeModule()
    {
        ...
        $This.Script.Add(6,"InstallFeModule","Install [FightingEntropy()]",@(
    ...
    InstallChoco()
    {
        ...
        $This.Script.Add(7,"InstallChoco","Install Chocolatey",@(
    ...
    InstallVsCode()
    {
        ...
        $This.Script.Add(8,"InstallVsCode","Install Visual Studio Code",@(
    ...
    InstallBossMode()
    {
        ...
        $This.Script.Add(9,"InstallBossMode","Install BossMode (vscode color theme)",@(
    ...
    InstallPsExtension()
    {
        ...
        $This.Script.Add(10,"InstallPsExtension","Install Visual Studio Code (PowerShell Extension)",@(
        '$FilePath     = "$Env:ProgramFiles\Microsoft VS Code\bin\code.cmd"';
    ...
    RestartComputer()
    {
        ...
        $This.Script.Add(11,'Restart','Restart computer',@('Restart-Computer'))
    }
    ConfigureDhcp()
    {
        # [Phase 12] Configure Dhcp
        $This.Script.Add(12,'ConfigureDhcp','Configure Dhcp',@(
    ...
    InitializeFeAd([String]$Pass)
    {
        ...
        $This.Script.Add(13,'InitializeAd','Initialize [FightingEntropy()] AdInstance',@(
