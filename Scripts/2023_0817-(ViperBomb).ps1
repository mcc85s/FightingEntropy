...
# ViperBombController scope WILL allow this function to work a LOT faster.
    ...
    Class ViperBombXaml
    {
        ...
        '                                    <RowDefinition Height="40"/>',
        '                                </Grid.RowDefinitions>',
        '                                <DataGrid Grid.Row="0" Name="EditionCurrent">',
        '                                    <DataGrid.Columns>',
        ...
        '                                </Grid>',
        '                                <DataGrid Grid.Row="1" Name="SettingsOutput">',
        '                                    <DataGrid.Columns>',
        '                                        <DataGridTextColumn Header="Type"',
        '                                                            Width="100"',
        '                                                            Binding="{Binding Source}"',
        ...
        '                                    </Grid.ColumnDefinitions>',
        '                                    <Button Grid.Column="0"',
        '                                            Name="SettingsOutputApply"',
        '                                            Content="Apply"',
        '                                            IsEnabled="False"/>',
        '                                    <Button Grid.Column="1"',
        '                                            Name="SettingsOutputDontApply"',
    ...
    Class ViperBombController
    {
        ...
        SettingsPanel()
        {
            ...
            # [Control Subtab]
            $Ctrl.Reset($Ctrl.Xaml.IO.SettingsOutput,$Ctrl.Settings.Output)
