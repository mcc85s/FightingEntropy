<#
[04/09/23]: [Virtualization Lab - RHEL Deployment]

Create a standard [Red Hat Enterprise Linux] installation using [Hyper-V] and [PowerShell Direct]
#>
...
# // Wait for "Install RHEL menu" and do not test the installation media
$Vm.Timer(2)
$Vm.TypeChain(@(38,13))
...
# // Set subscription service to access (yum/rpm)
$Vm.LinuxType("subscription-manager register")
$Vm.TypeKey(13)
$Vm.Timer(1)
$Vm.LinuxType($User.Username)
$Vm.TypeKey(13)
...
# // Set epel-release repository
$Vm.LinuxType('subscription-manager repos --enable codeready-builder-for-rhel-9-$(arch)-rpms')
$Vm.TypeKey(13)
$Vm.Idle(0,5)
