# Retooling all of the config classes + controller classes
...
Class AddsServerSiteReference
{
    ...
    [String] ToString()
    {
        Return "<FEInfrastructure.Config.AddsServer.SiteReference>"
    }
}
...
Class AddsServerSubnetReference
{
    ...
    [String] ToString()
    {
        Return "<FEInfrastructure.Config.AddsServer.SubnetReference>"
    }
}
...
Class AddsServer
{
    ...
    GetSubnet()
    {
        ...
        <#
        $List                       = $Adds.Domain.GetList("Subnet").Output

        ForEach ($Network in $Adds.Subnet.Output)
        {
            $Item = $Adds.AddsServerSubnetReference($Adds.Subnet.Output.Count,$Network,$Adds.SubnetSearchBase)
