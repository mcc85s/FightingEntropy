...
.LINK
.NOTES
          FileName : EventLogs-UtilityRunspaces-v4.ps1
...
# // | This function collects the currently loaded assemblies in the PowerShell host |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // | This function controls all of the individual threads as well as the runspace pool and throttling |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
Function Get-ThreadController
{
    ...
    Class ThreadSlot
    {
        ...
        EndInvoke()
        {
            ...
            ForEach ($Item in $This.Thread)
            {
                If ($Item.Handle.IsCompleted -and $Item.Complete -ne 1)
                {
                    $Item.EndInvoke()
                    $This.Update(1,"Closing [~] [Thread]://(Rank: $($Item.Rank), InstanceId: ($($Item.PowerShell.InstanceId))")
                }
                If ($Item.Handle.IsCompleted -and $Item.Complete -eq 1)
                {
                    $This.Update(1,"Closed [!] [Thread]://(Rank: $($Item.Rank), InstanceId: ($($Item.PowerShell.InstanceId))")
                }
                If (!$Item.Handle.IsCompleted)
                {
                    $This.Update(1,"Running [!] [Thread]://(Rank: $($Item.Rank), InstanceId: ($($Item.PowerShell.InstanceId))")
                }
            }
        ...
        IsComplete()
        {
            ...
            If (($This.Thread | ? Complete).Count -eq $This.Total)
            {
                $This.Time.Stop()
                $This.Complete = 1
                $This.Dispose()
...
# // | Essentially geared for the graphical user interface, it's not a real noteworthy function otherwise |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // | This is specifically for a portion of the GUI but may be used elsewhere |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // | This is not completely necessary but I was using this to troubleshoot the threading dispatcher |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // ____________________________________________________________________________________________________
# // | This function is the main function that collects system information and formats it all to export |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
Function Get-SystemDetails
{
    ...
    # Specifically for single OR multiple partitions on a given drive
    Class Partitions
    {
        [UInt32] $Count
        [Object] $Output
    ...
    # Specifically for single OR multiple volumes on a given drive
    Class Volumes
    {
        [UInt32] $Count
        [Object] $Output
...
# // ______________________________________________________________________________________________________
# // | This function extends the functionality of the default EventLogConfig class, and (imports/exports) |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // ______________________________________________________________________________________________________
# // | This function extends the functionality of the default EventLogRecord class, and (imports/exports) |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // | This basically compiles an archive of the event logs (like a PK3 file) so they can be (imported/exported) |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // | A subcontroller for the EventLog Utility |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // | Xaml object of the EventLog Utility |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // _______________________________________
# // | Controller for the EventLog Utility |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------
# Load these types/modules before executing the script, this won't be necessary when it is included in the FightingEntropy module.
# ---------------------------------------------------------------------------------------------------------------------------------------------------------

<# 
Add-Type -Assembly System.IO.Compression, System.IO.Compression.Filesystem, System.Windows.Forms, PresentationFramework
. C:\Users\mcadmin\Documents\Scripts\EventLog-UtilityRunspaceControl.ps1
#>

# ---------------------------------------------------------------------------------------------------------------------------------------------------------
# Prep the 1) sync hash, 2) thread controller, 3) subcontroller, 4) Project, and 5) Window/Types/UI variables to control the user interface.
# ---------------------------------------------------------------------------------------------------------------------------------------------------------

$Global:Sync        = [Hashtable]::Synchronized(@{})        # Global synchronized hashtable, it orchestrates nearly everything 
$Sync.Control       = Get-ThreadController #-Reserve 1       # Throttling, CPU Core Calculations, Runspace Controls, Session State Entries, Logging, etc.
$Sync.Thread        = $Sync.Control.NewThreadSubcontrol()   # A Subcontroller to offload SOME of the heavy handedness of the ThreadController
$Sync.Project       = $Null                                 # Collects properties to [Import an existing archive], or [Create a new one]
$Sync.Mode          = -1                                    # Determines the operation mode of the utility (Import/Export/Etc.)
$Sync.Window        = $Null                                 # XamlWindow, used to oversee the Dispatcher objects on window controls 
$Sync.Types         = @( )                                  # Expands the standard UI XAML controls, for dispatching and threading
$Sync.UI            = $Null                                 # Controls the User Interface

$Sync.Default       = "UserInterface","AutoThreading","Launcher","GetEventLogs","ImportEventLogs","ExportEventLogs"
...
{
    $Sync.Control.AddAssembly($Assembly)
...
{
    $Sync.Control.AddFunction($Function)
    [Console]::WriteLine("Function [+] [$Function]")
}

ForEach ($Variable in "Sync" | % { Get-Variable $_ })
{
    $Sync.Control.AddVariable($Variable.Name,$Variable.Value,$Variable.GetType().Name)
    [Console]::WriteLine("Variable [+] [$($Variable.Name)]")
}

# --------------------- #
# Open Runspace Factory #
# --------------------- #

$Sync.Control.SetFactoryType("RunspacePool")
$Sync.Control.Factory.Open()

# ------------------------ #
# Assign Sync.Thread.Slots #
# ------------------------ #

$Sync.Default | % { $Sync.Control.NewThreadSlot($_); $Sync.Thread.Add($Sync.Control.GetThreadSlot($_)) }

# ------------------------------------------ #  
# Select ThreadSlot to prepare UserInterface # 
# ------------------------------------------ # 

# Index   : 0
# Name    : UserInterface

$Slot         = $Sync.Thread.Slot | ? Name -eq UserInterface      # Selects the correct ThreadSlot for the UI
If ($Slot.Thread.Count -eq 0)
{
    $Sync.Control.SetThreadSlotCount($Slot,1)                     # This adds (1) ISS prepped thread to the slot
}
$Sync.Thread.Add($Slot.Thread[0])                                 # Assigns the new thread to the subcontroller
$UserInterface = $Sync.Thread.Object | ? Slot -match $Slot.Index  # Selects the correct thread based on properties

# ----------------------------- # 
# First Script for first thread # 
# ----------------------------- #

$UserInterface.AddScript(
{
    # --------------------------------- #
    # Prepare (Xaml/Window/UI/Controls) #
    # --------------------------------- #

    $Xaml                = Get-EventLogXaml
    $Names               = [Regex]::Matches($Xaml,"(\s*Name\s*=\s*('|`")\w+)").Value -Replace "\s*Name=\`"","" | Select-Object -Unique
    $Sync.Window         = [Windows.Markup.XamlReader]::Load([System.Xml.XmlNodeReader]::New([Xml]$Xaml))
    $Sync.UI             = Get-EventLogController
    $Sync.UI.SetWindow($Sync.Window)
    ForEach ($X in 0..($Names.Count-1))
    {
        $Name            = $Names[$X]
        ...
        If ($Control)
        {   
            # Adds Xaml controls to the sync hashtable with extended properties for each control, also imports into the UI class
    ...
    [Action]{
        ...
        $Sync.Window.Time.IsEnabled                 = 0
        $Sync.Window.Start.IsEnabled                = 0
        $Sync.Window.DisplayName.IsEnabled          = 0
        $Sync.Window.Guid.IsEnabled                 = 0

        # [System] ComboBoxes (Disabled)   
        $Sync.Window.Section.IsEnabled              = 0
        $Sync.Window.Slot.IsEnabled                 = 0

        # [Pseudo TabControl] Buttons (Disabled)
        $Sync.Window.LogTab.IsEnabled               = 0
        $Sync.Window.OutputTab.IsEnabled            = 0
        $Sync.Window.ViewTab.IsEnabled              = 0

        # [Throttle/Threading] (Enabled)   
        $Sync.Window.Throttle.IsEnabled             = 1 
        $Sync.Window.AutoThrottle.IsEnabled         = 1

        $Sync.Window.Reset($Sync.Window.Throttle.Items, $Sync.Control.Index.Output.Label)
        $Sync.Window.Reset($Sync.Window.Threads.Items,  $Sync.Control.Index.Total)

        $Sync.Window.Threads.SelectedIndex          = 0
        $Sync.Window.Threads.IsEnabled              = 0
    
        # [Archive] Controls (Enabled)
        $Sync.Window.Archive.IsEnabled              = 1
        $Sync.Window.Base.IsEnabled                 = 1
        $Sync.Window.Mode.IsEnabled                 = 1
    
    }, "Normal")

    # ------------------------ #
    # MainPanel Event Handlers #
    #------------------------- #
    ...
    $Sync.UI.AutoThrottle.Add_Checked(
    {
        ...
        # --------------------------------------- #
        # Select [~] ThreadSlot for AutoThreading #
        # --------------------------------------- #

        # Index   : 1
        # Name    : AutoThreading

        $Slot    = $Sync.Thread.Slot | ? Name -match AutoThreading
        If ($Slot.Thread.Count -eq 0)
        {
            $Sync.Control.SetThreadSlotCount($Slot,1)
        }
        
        # ------------------------------------- #
        # Add [+] ThreadObject to Subcontroller #
        # ------------------------------------- #
        
        $Sync.Thread.Add($Slot.Thread[0])

        $AutoThread = $Sync.Thread.Object | ? Slot -match $Slot.Index
        $AutoThread.AddScript(
        {
            $Sync.Control.AutoThrottle()
            If ($Sync.Control.Throttle -ne $Sync.Control.Index.Current)
            {
                $Sync.Control.Throttle = $Sync.Control.Index.Current
            }
            If ($Sync.UI.Throttle.SelectedItem -ne $Sync.Control.Throttle.Label)
            {
                $Sync.UI.Throttle.Dispatcher.Invoke([Action]{$Sync.UI.Throttle.SelectedItem = $Sync.UI.Throttle.Items.IndexOf($Sync.Control.Throttle.Label) })
            }
        })

        # ---------------------------------------------------- #
        # Invoke the Parent slot, instead of the actual thread # 
        # ---------------------------------------------------- #
    ...
    {
        If ($Sync.UI.Throttle.SelectedItem -ne $Sync.ThreadControl.Throttle.Label)
        {
            $Sync.UI.Throttle.Dispatcher.Invoke([Action]{ $Sync.UI.Throttle.SelectedItem = $Sync.UI.Throttle.Items.IndexOf($Sync.ThreadControl.Throttle.Label) })
        }
    })
    ...
    $Sync.UI.Continue.Add_Click(
    {
        # ---------------------------------- #
        # Select [~] ThreadSlot for Launcher #
        # ---------------------------------- #

        # Index   : 2
        # Name    : Launcher

        $Slot = $Sync.Thread.Slot | ? Name -match Launcher
        If ($Slot.Thread.Count -eq 0)
        {
            $Sync.Control.SetThreadSlotCount($Slot,1)
        }
        ...
        # ----------------------------------------- #
        # Add [+] ThreadObject to the Subcontroller #
        # ----------------------------------------- #

        $Sync.Thread.Add($Slot.Thread[0])

        $Launcher  = $Sync.Thread.Object | ? Slot -match $Slot.Index

        $Sync.UI.Continue.Dispatcher.Invoke([Action]{ $Sync.UI.Continue.IsEnabled = 0 },"Normal")
        $Sync.UI.Submain(1)

        # ------------------------------- #
        # Get-EventLogs Process Selection #
        # ------------------------------- #
        ...
        If ($Sync.Mode -eq 0)
        {
            ...
            {
                # -------------------------------------- #
                # Select [~] ThreadSlot for GetEventLogs #
                # -------------------------------------- #

                # Index   : 3
                # Name    : GetEventLogs

                $Slot = $Sync.Thread.Slot | ? Name -match GetEventLogs
                If ($Slot.Thread.Count -eq 0)
                {
                    $Sync.Control.SetThreadSlotCount($Slot,4)
                }
                ...
                $GetEventLogs = $Sync.Thread.Object | ? Slot -match $Slot.Index
            })
        }

        # ---------------------------------- #
        # Import-EventLogs Process Selection #
        # ---------------------------------- #
        
        If ($Sync.Mode -eq 1)
        {
            If (![System.IO.File]::Exists($Sync.UI.Base.Items))
            {
                Throw "Invalid file path"
            }

            $Sync.UI.Table.Dispatcher.Invoke(
            [Action]{ 
                
                $Sync.UI.Table.Items.Add($Sync.Project.Console.Last()) 
            
            }, "Normal")

            $Sync.Project.Console.Update("Success",1,"Output console connected")

            $Sync.UI.Browse.Dispatcher.Invoke(       [Action]{ $Sync.UI.Browse.IsEnabled       = 0}, "Normal")
            $Sync.UI.Continue.Dispatcher.Invoke(     [Action]{ $Sync.UI.Continue.IsEnabled     = 0}, "Normal")
            $Sync.UI.Throttle.Dispatcher.Invoke(     [Action]{ $Sync.UI.Throttle.IsEnabled     = 0}, "Normal")
            $Sync.UI.AutoThrottle.Dispatcher.Invoke( [Action]{ $Sync.UI.AutoThrottle.IsEnabled = 0}, "Normal")
            $Sync.UI.Threads.Dispatcher.Invoke(      [Action]{ $Sync.UI.Threads.IsEnabled      = 0}, "Normal")
            ...
            {
                # ----------------------------------------- #
                # Select [~] ThreadSlot for ImportEventLogs #
                # ----------------------------------------- #
                
                # Index   : 4
                # Name    : ImportEventLogs

                $Slot = $Sync.Thread.Slot | ? Name -match ImportEventLogs
                If ($Slot.Thread.Count -eq 0)
                {
                    $Sync.Control.SetThreadSlotCount($Slot,4)
                }
                ...
                # ------------------------------------ #
                # Ascertain Archive, then load Project #
                # ------------------------------------ #

                $Archive          = $Sync.UI.Pull("Archive") | % Data
                $Restore          = @( If (!!$Archive -and ($Archive.Path | Test-Path))
                {
                    $Archive
                }
                Else
                ...
                # --------------------------------- #
                # Set GUI intial changed conditions #
                # --------------------------------- #

                $ImportEventLogs  = $Sync.Thread.Object | ? Slot -match $Slot.Index
                $ImportEventLogs.AddScript(
                {
                    # -------------------- #
                    # Restore the zip file #
                    # -------------------- #

                    $Sync.Project.Update("(0.0) Testing", 0, "Zip file path input")
                    If ($Sync.Project.Archive.State -ne 0)
                    {
                        Throw $Sync.Project.Archive.Status
                    }
                    $Sync.Project.Base       = $Sync.Project.Archive.Path -Replace ".zip",""
                    $Sync.Project.Update("(0.0) Tested", 1, $Sync.Project.Archive.Status)
            
                    # ---------------------------------- #
                    # Zip path exists, is it a zip file? #
                    # ---------------------------------- #

                    $Sync.Project.Update("(0.1) Opening", 0, "Zip file")
                    $Sync.Project.Archive.Open()
                    If ($Sync.Project.Archive.State -ne 1)
                    {
                        Throw $Sync.Project.Archive.Status
                    }
                    $Sync.Project.Update("(0.1) Opened", 1, $Sync.Project.Archive.Status)
            
                    # ----------- #
                    # Get Entries #
                    # ----------- #

                    $Sync.Project.Update("(0.2) Populating", 0, "Table Entries")
                    $Sync.Project.Archive.PopulateEntryTable()
                    $Sync.Project.Update("(0.2) Populated", 1, "Table Entries")
                    
                    # ----------- #
                    # Master file #
                    # ----------- #

                    $Sync.Project.Update("(0.2) Extracting", 0, "Master.txt")
                    $File                = $Sync.Project.Archive.File("Master.txt")
                    $Stream              = $File.Open()
                    $Reader              = [System.IO.StreamReader]::New($Stream)
                    $Master              = $Reader.ReadToEnd()
                    $Reader.Close()
                    $Stream.Close()
                    $Sync.Project.Update("(0.2) Extracted", 1, "Master.txt")
                    
                    # ---------------------- #
                    # Restore system details #
                    # ---------------------- #

                    $Sync.Project.Update("(0.3) Restoring", 0, "(Captured) system details")
                    If ($Master)
                    {
                        $Sync.Project.System      = $Master | Get-SystemDetails
                        If (!$Sync.Project.System)
                        {
                            Throw $Sync.Project.Error("Failed to restore captured system details")
                        }
                        $Sync.Project.Start       = $Sync.Project.System.Snapshot.Start
                        $Sync.Project.DisplayName = $Sync.Project.System.Snapshot.DisplayName
                        $Sync.Project.Threads     = $Sync.Project.System.Processor.Output.Threads
                        $Sync.Project.Guid        = $Sync.Project.System.Snapshot.Guid
                    }
                    $Sync.Project.Update("(0.3) Restored", 1, "System details")
            
                    # ---------------------------------------- # 
                    # Extract Logs.txt/Provider Configurations # 
                    # ---------------------------------------- # 

                    $Sync.Project.Update("(0.4) Extracting", 0, "Logs.txt")
                    $File                   = $Sync.Project.Archive.File("Logs.txt")
                    $Stream                 = $File.Open()
                    $Reader                 = [System.IO.StreamReader]::New($Stream)
                    $LogsFile               = $Reader.ReadToEnd() | ConvertFrom-Json
                    $Reader.Close()
                    $Stream.Close()
                    $Sync.Project.Update("(0.4) Extracted", 1, "Logs.txt")
            
                    # --------------------- #
                    # Process the log files #
                    # --------------------- #

                    $Sync.Project.Update("(0.5) Restoring", 0, "(Captured) Event log providers")
                    $Sync.Project.Logs      = @( )
                    $Stash                  = @{ }
                    $Hash                   = @{ }
                    ForEach ($X in 0..($LogsFile.Count-1))
                    {
                        ...
                        If (!$Item)
                        {
                            $Sync.Project.Error("Unable to retrieve log configuration extension for Logs.txt[$X]")
                        }
                        $Item.Output        = @( )
                        $Stash.Add($Item.LogName,@{ })
                        $Sync.Project.Logs += $Item
                    }
                    $Sync.Project.Update("(0.5) Restored", 1, "Event log providers")
            
                    # ------------------ #
                    # Process the events #
                    # ------------------ #

                    $Sync.Project.Update("(0.6) Importing", 0, "(Captured) Events")
                    $Events               = $Sync.Project.Archive.Zip.Entries | ? Name -notmatch "(Master|Logs).txt"
                    $Id                   = $Sync.Project.NewProgressObject($Events)
                    $Sync.Project.Update("(1.0) Importing", 0, "(0.00%) Events: ($($Id.Total)) found.")
                    ForEach ($X in 0..($Id.Total-1))
                    {
                        $Item             = Get-EventLogRecordExtension -Index $X -Entry $Events[$X]
                        $Hash.Add($X,$Item)
                        ...
                        If ($X -in $Id.Index.Slot)
                        {
                            $Sync.Project.Update("(1.0) Importing", 0, $Id.Slot($X).Line())
                        }
                        If ($X -eq $Id.Total)
                        {
                            $Sync.Project.Update("(1.0) Importing", 0, $Id.Index[-1].Line())
                        }
                    }
                    $Sync.Project.Update("(1.0) Imported", 1, "(100.00%) [+] Events: ($($Id.Total)) found.")

                    # ------------------ #
                    # Prepare the output #
                    # ------------------ #

                    $Sync.Project.Output  = $Hash[0..($Hash.Count-1)]
            
                    # ----------------------- #
                    # Dispose of the zip file #
                    # ----------------------- #

                    $Sync.Project.Archive.Zip.Dispose()
            
                    # ------------- #
                    # Sort the logs #
                    # ------------- #

                    $Sync.Project.Update("(1.1) Restoring", 0, "Events for each log provider")
                    $Id                   = $Sync.Project.NewProgressObject($Sync.Project.Logs)
                    $Sync.Project.Update("(1.1) Sorting", 0, "(0.00%) [~] Logs: ($($Id.Total)) found.")
                    ForEach ($X in 0..($Id.Total-1))
                    {
                        $Name             = $Sync.Project.Logs[$X].LogName
                        Switch ($Stash[$Name].Count)
                        {
                            0 
                            { 
                                $Sync.Project.Logs[$X].Output = @( ) 
                            } 
                            1 
                            { 
                                $Sync.Project.Logs[$X].Output = @($Sync.Project.Output[$Stash[$Name][0]]) 
                            } 
                            Default 
                            { 
                                $Sync.Project.Logs[$X].Output = @($Sync.Project.Output[$Stash[$Name][0..($Stash[$Name].Count-1)]]) 
                            }
                        }
                        $Sync.Project.Logs[$X].Total          = $Sync.Project.Logs[$X].Output.Count
                        If ($X -in $Id.Index.Slot)
                        {
                            $Sync.Project.Update("(1.1) Sorting", 0, $Id.Slot($X).Line())
                        }
                        If ($X -eq $Id.Total)
                        {
                            $Sync.Project.Update("(1.1) Sorting", 0, $Id.Index[-1].Line())
                        }
                    }
                    $Sync.Project.Update("(1.1) Sorted", 1, "(100.00%) [+] Logs: ($($Id.Total)) found.")
                    $Sync.Project.Time.Stop()
                })
...
$Slot         = $Sync.Thread.Slot | ? Name -eq UserInterface     # Selects the correct ThreadSlot for the UI
$Slot.BeginInvoke()                                              # This initializes the Main UI thread from the ThreadSlot 

# // ______________________________________________________________________________
# // | [GetEventLogs]                                                             |
# // | Load these types/modules before executing the script.                      |
# // | this won't be necessary when it is included in the FightingEntropy module. |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
$Sync.Control       = Get-ThreadController
$Sync.Thread        = $Sync.Control.NewThreadSubcontrol()
$Sync.Project       = $Null
$Sync.Mode          = -1
$Sync.Window        = $Null
$Sync.Types         = @( )
$Sync.UI            = $Null
$Sync.Default       = "GetEventLogs","ExportEventLogs"
...
# // | Assign Thread Controller Default Slots |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
If ($Slot.Thread.Count -eq 0)
{
    $Sync.Control.SetThreadSlotCount($Slot,$Sync.Control.Throttle.Core)
}

# // Set the thread count
$Slot.Thread     | % { $Sync.Thread.Add($_) }

# // Set variable $Threads
$Threads         = $Slot.Thread

# // Set variable $Archive
$Archive         = Get-EventLogArchive -New

# // Instantiate the EventLogProject function, then initialize
$Sync.Project    = Get-EventLogProject -ThreadSlot $Slot -New
$Sync.Project.Init()

# // Set variable $Files to select each individual file to process
$Files           = $Sync.Project.Base.Slot("Threads").Children.Fullname

# // Set variable $ScriptBlock to process each $File in $Files, on each $Thread in $Threads
$ScriptBlock     = {
    Param ($Fullname)
...
# // Add the scriptblock as well as the argument for each thread
ForEach ($X in 0..($Threads.Count-1))
{
    $Threads[$X].PowerShell.AddScript($ScriptBlock).AddArgument($Files[$X]) | Out-Null
}

# // Initialize all of the runspaces simultaneously
$Slot.BeginInvoke()

# // This block here monitors the threads until the work is completed
$Start = [DateTime]::Now
Do
{
    $Slot.Query()

    $Content = @("Running [~] $($Slot.Name)",
    " ",
    "Index Status           Complete",
    "----- ------           --------";
    ForEach ($Thread in $Slot.Thread)
    { 
        "{0:d5} {1}        {2}" -f $Thread.Index, $Thread.Status, $Thread.Complete;
    };
    " ",
    "Elapsed: [$([TimeSpan]([DateTime]::Now-$Start))]") -join "`n"
...
$Slot.Status.Finalize()

Write-Theme "Complete [~] $($Slot.Name) [$($Slot.Status)]" @(10,2,15,0)

# // _____________________________________________________
# // | Dispose the thread slot since the job is complete |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
$Sync.Control.DisposeThreadSlot("GetEventLogs")

# // Sort each log provider by RANK, and then SAVE/EXPORT each individual log to the same file
Write-Theme "Sorting [~] Logs: Index/Rank, Elapsed: [$($Sync.Control.Status.Elapsed())]" @(6,14,15,0)
$Sync.Project.Logs   = $Slot.Thread.Output | Sort-Object Rank 
$Sync.Project.SaveLogs()

# // Sort all INDIVIDUAL LOGS by TimeCreated, 
Write-Theme "Sorting [~] Logs: TimeCreated, Elapsed: [$($Sync.Control.Status.Elapsed())]" @(6,14,15,0)
$Swap                = $Sync.Project.Logs.Output | Sort-Object TimeCreated

# // Prepare for (naming/indexing), open hashtable
Write-Theme "Indexing [~] Output, Elapsed: [$($Sync.Control.Status.Elapsed())]" @(6,14,15,0)
$Count               = $Swap.Count
$Depth               = ([String]$Count).Length
$Load                = @{ }
$T                   = $Threads.Count
$P                   = $Sync.Project.Progress("Indexing [~]",$Swap.Count)
...
Write-Progress -Activity $P.Activity -Status $P.Status -PercentComplete 0
...
# // ____________________________________________
# // | This selects the ExportEventLogs feature |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯

<#
$Source = "C:\Users\mcadmin\AppData\Local\Temp\2032c0c1-25ce-4a75-82d6-c17629bfc530\Events"
$Dest   = "C:\Users\mcadmin\AppData\Local\Temp\517ba2a3-3021-4e01-88c6-9282740895b4\Events"
$List   = @([System.IO.Directory]::EnumerateFiles("$Source"))
$P      = $Sync.Project.Progress("Moving [~]",$List.Count)
Write-Progress -Activity $P.Activity -Status $P.Status -PercentComplete 0
ForEach ($X in 0..($List.Count-1))
{
    If ($X -in $P.Range)
    ...
    Move-Item $List[$X] $Dest
}
Write-Progress -Activity $P.Activity -Status $P.Status -Complete
#>

$Slot = $Sync.Control.Slot | ? Name -eq ExportEventLogs
If ($Slot.Thread.Count -eq 0)
{
    $Sync.Control.SetThreadSlotCount($Slot,$Sync.Control.Throttle.Core)
}
...
$Threads        = $Slot.Thread
$Target         = $Sync.Project.Base.Slot("Events")
$ScriptBlock    = {
    ...
    {
        $Item = $Load[$X] | Get-EventLogRecordExtension
        $Path = "$Target\$($Item.Name).log"
        If (!(Test-Path $Path))
        {
            [System.IO.File]::WriteAllLines($Path,$Item)
        }
    }
}

# add the scriptblock, insert an argument for filepath
ForEach ($X in 0..($Threads.Count-1))
{
    $Threads[$X].PowerShell.AddScript($ScriptBlock).AddArgument($Target).AddArgument($Load[$X]) | Out-Null
}
...
# // This block here monitors the threads until the work is completed
$P                   = $Sync.Project.Progress("Writing [~]",$Swap.Count)
$Start               = [DateTime]::Now
Do
{
    Clear-Host
    ...
    $Percent         = $P.Slot | ? Step -le $Count | Select-Object -Last 1
    $P.Status        = $Percent
...
<#
PS C:\Users\mcadmin> $Slot.EndInvoke()
...
At C:\Program Files\WindowsPowerShell\Modules\FightingEntropy\2022.10.0\FightingEntropy.psm1:18737 char:33
+             If (($This.Thread | ? Complete).Count -eq $This.Total)
+                                 ~
    + CategoryInfo          : ObjectNotFound: (?:String) [], CommandNotFoundException
    + FullyQualifiedErrorId : CommandNotFoundException
 
PS C:\Users\mcadmin> $Slot.Status.Finalize()
PS C:\Users\mcadmin> Write-Theme "Complete [~] $($Slot.Name) [$($Slot.Status)]" @(10,2,15,0)
Cannot convert value "Complete [~] ExportEventLogs [09:36:00.4592486]" to type "Write-Theme.ThemeObject". Error: "The term '?' is not recognized as 
the name of a cmdlet, function, script file, or operable program. Check the spelling of the name, or if a path was included, verify that the path is    
...
At C:\Program Files\WindowsPowerShell\Modules\FightingEntropy\2022.10.0\FightingEntropy.psm1:41803 char:13
+             $Item.Output.Draw(@($Palette))
+             ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : InvalidOperation: (:) [], RuntimeException
    + FullyQualifiedErrorId : InvokeMethodOnNull
 
PS C:\Users\mcadmin> Write-Theme "Complete [~] $($Slot.Name) [$($Slot.Status)]"
Cannot convert value "Complete [~] ExportEventLogs [09:36:00.4592486]" to type "Write-Theme.ThemeObject". Error: "The term '?' is not recognized as 
the name of a cmdlet, function, script file, or operable program. Check the spelling of the name, or if a path was included, verify that the path is    
correct and try again."
+             $This.Object = [ThemeObject]$InputObject
...
PS C:\Users\mcadmin> $Sync.Control.DisposeThreadSlot("ExportEventLogs")
? : The term '?' is not recognized as the name of a cmdlet, function, script file, or operable program. Check the spelling of the name, or if a path    
was included, verify that the path is correct and try again.
At C:\Program Files\WindowsPowerShell\Modules\FightingEntropy\2022.10.0\FightingEntropy.psm1:19197 char:44
+             $Item           = $This.Slot | ? Name -eq $Name
    + CategoryInfo          : ObjectNotFound: (?:String) [], CommandNotFoundException
    + FullyQualifiedErrorId : CommandNotFoundException
 
PS C:\Users\mcadmin> $Sync.Project.SaveMaster()
% : The term '%' is not recognized as the name of a cmdlet, function, script file, or operable program. Check the spelling of the name, or if a path    
was included, verify that the path is correct and try again.
At C:\Program Files\WindowsPowerShell\Modules\FightingEntropy\2022.10.0\FightingEntropy.psm1:16815 char:39
+             Return @( $This.Content | % GetOutput )
+                                       ~
    + CategoryInfo          : ObjectNotFound: (%:String) [], CommandNotFoundException
    + FullyQualifiedErrorId : CommandNotFoundException
 
PS C:\Users\mcadmin> $Sync.Control

Index     : (Total: 4 / Reserved: 0 / Available: 4 / Segment: 0.25)
Throttle  : (4) 100.00%
Maximum   : (4) 100.00%
Minimum   : (1) 25.00%
Type      : RunspacePool
Factory   : System.Management.Automation.Runspaces.RunspacePool
Slot      : {GetEventLogs, ExportEventLogs}
Allocated : 4
Projected : 0
Disposed  : 0
Session   : System.Management.Automation.Runspaces.InitialSessionState
Assembly  : {System.Windows.Forms, PresentationFramework, System.IO.Compression, System.IO.Compression.Filesystem}
Function  : {Get-ThreadController, Get-AssemblyList, Get-SystemDetails, Get-PropertyItem...}
Variable  : {Sync}
Argument  : {}
Command   : {}
Status    : 09:37:13.6342962
Last      : [00:25:27.1380734] (State: 1/Status: ThreadSlotCount [+] Passed: (4) thread(s) available.)

PS C:\Users\mcadmin> $Sync.Project 
   
Console     : Get-EventLogProject.ProjectConsole
Time        : System.Diagnostics.Stopwatch
Start       : 10/24/2022 10:39:25 AM
System      :
DisplayName : 2022-1024-103925-L420-X64
Threads     : 4
Guid        : 3f673bfc-ee6a-43be-ad56-a7504890fecd
Base        : C:\Users\mcadmin\AppData\Local\Temp\3f673bfc-ee6a-43be-ad56-a7504890fecd
Logs        :
Output      : {}
