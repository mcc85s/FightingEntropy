...
Class cimdbClientIdentity
{
    ...
    cimdbClientIdentity([Object]$Xaml)
    {
        ...
        $This.Country       = $Xaml.IO.EditClientCountry.Text
...
Class cimdbController
{
    ...
    CheckIdentity()
    {
        ...
        If (!!$This.Current.Source -and $This.Current.Source.Hash -ne $This.Current.Target.Hash)
        {
    ...
    Stage([String]$Name)
    {
        ...
        Switch ($Name)
        {
            ...
            EditClient
            {
                ...
                $Ctrl.Xaml.IO.EditClientCountry.Add_TextChanged(
                {
                    If ($Ctrl.Mode -eq 0)
                    {
                        $Ctrl.CheckIdentity()
                ...
                {
                    $Phone = $Ctrl.Xaml.IO.EditClientPhoneText.Text
                    $List  = $This.Database.GetRecordSlot("Client") | ? { $_.Record.Phone.Output.Number -match $Phone }
            ...
            EditClient
            {
                ...
                Switch ([UInt32]!!$Ctrl.Current.Uid)
                {
                    ...
                    1
                    {
                        ...
                        # Disables raising the event handlers
                        $Ctrl.Mode = 1
                        ...
                        # Re-enables raising the event handlers
                        $Ctrl.Mode = 0
                    }
                }
            }
    ...
    View()
    {
        ...
        Switch -Regex ($Ctrl.Current.Mode.Name)
        {
            ...
            Client
            {
                ...
                $Ctrl.Xaml.IO.EditClientCountry.IsReadOnly        = 1
    ...
    Edit()
    {
        ...
        Switch -Regex ($Ctrl.Current.Mode.Name)
        {
            ...
            Client
            {
                $Ctrl.Current.Source = $Ctrl.ClientIdentity().GetHash().Hash
                ...
                $Ctrl.Xaml.IO.EditClientCountry.IsReadOnly         = 0
