...
Class NewVmControllerNodeVariable
{
    ...
    [String] $Description
    [String] $Value
    NewVmControllerNodeVariable([UInt32]$Index,[String]$Type,[String]$Description,[String]$Value)
    {
        $This.Index       = $Index
        $This.Type        = $Type
...
Class NewVmControllerNodeVariableMaster
{
    ...
    [Object] NewVmControllerNodeVariable([UInt32]$Index,[String]$Type,[String]$Description,[String]$Value)
    {
        Return [NewVmControllerNodeVariable]::New($Index,$Type,$Description,$Value)
    }
    Add([String]$Type,[String]$Description,[String]$Value)
    {
        $This.Output += $This.NewVmControllerNodeVariable($This.Output.Count,$Type,$Description,$Value)
    }
    Remove([String]$Name)
    {
        $Item = $This.Output | ? Name -eq $Name
...
Class NewVmControllerNodeObject
{
    ...
    [Void] RunScript()
    {
        ...
        If ($This.Smb.Connected)
        {
            $Line = "[System.IO.File]::WriteAllLines('{0}','[+] Script [{1}]')" -f $This.Smb.RemoteStatusPath(),
                                                                                   $Current.Name
            ...
            Until ($Status -or $X -eq $Current.Timeout)
        }
