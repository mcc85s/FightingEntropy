        ...
        Stage([String]$Name)
        {
            ...
            Switch ($Name)
            {
                ...
                Template
                {
                    ...
                    {
                        $Ctrl.Template.Export($Ctrl.Xaml.TemplateExportPath.Text,
                                              $Ctrl.Master.Network,
                    ...
                    $Ctrl.Xaml.IO.TemplateNetworkUp.Add_Click(
                    {
                        ...
                        If ($Current.Index -ge 1)
                        {
                            $Item.Index --
                            $Target.Index ++
                            $List = $List | Sort-Object Index
                            $Ctrl.Reset($Ctrl.Xaml.IO.TemplateNetworkOutput,$List)
                            $Current = $Ctrl.Xaml.IO.TemplateNetworkOutput | ? Alias -eq $Current.Alias
                            $Ctrl.Xaml.IO.TemplateNetworkOutput.SelectedItem = $Current
                        }
                    })
        ...
        Handle([String]$Name)
        {
            Switch ($Name)
            {
                ...
                Node
                {
                    ...
                    $This.Xaml.IO.NodeUpdate.IsEnabled = 1
        
                    If ($This.Xaml.IO.NodeHostOutput.SelectedIndex -ne -1)
                    {
                        $Selected = $This.Xaml.IO.NodeHostOutput.SelectedItem
