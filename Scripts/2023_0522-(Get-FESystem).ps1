...
Class HotFixController
{
    ...
    Refresh()
    {
        ...
        ForEach ($HotFix in $This.GetHotFix())
        {
            $This.Add($HotFix)
        }
    }
...
Class EventLogProviderController
{
    ...
    Refresh()
    {
        ...
        ForEach ($Item in $This.GetWinEvent())
        {
            $This.Add($Item)
        }
    }
...
Class ScheduledTaskController
{
    ...
    Refresh()
    {
        ...
        ForEach ($Task in $This.GetScheduledTask())
        {
            $This.Add($Task)
        }
    }
...
<#
    ...
    [X] AppX Provisioned Applications
    [X] Applications
        [+] ToDo: [Packages]
    [X] Events
    [X] Tasks
...
Class SnapshotController
{
    ...
    RefreshAll()
    {
        ...
        ForEach ($Item in "HotFix Feature AppX Application Event Task" -Split " ")
        {
            $This.Refresh($Item)
        }
    }
    Refresh([String]$Name)
    {
        Switch ($Name)
        {
            ...
            { 
                ...
                ForEach ($HotFix in $Object.GetHotFix())
                {
            ...
            Feature
            {
                ...
                ForEach ($Feature in $Object.GetWindowsOptionalFeature())
                {
            ...
            { 
                ...
                ForEach ($AppX in $Object.GetAppXProvisionedPackage())
                {
            ...
            { 
                ...
                ForEach ($Application in $Object.GetApplications())
                {
            ...
            Event
            {
                ...
                ForEach ($WinEvent in $Object.GetWinEvent())
                {
            ...
            Task
            {
                ...
                ForEach ($Task in $Object.GetScheduledTask())
                {
