...
\\  Date       : 2023-06-14 20:39:38                                                                  //
 \\==================================================================================================// 

    FileName   : Invoke-cimdb.ps1
    Solution   : [FightingEntropy()][2023.4.0]
    Purpose    : Launches the [FightingEntropy()] Company Inventory Management Database
...
Class cimdbXaml
{
    ...
    '                        </TabItem>',
    '                    </TabControl>',
    '                    <DataGrid Grid.Row="6" Name="EditIssueRecordList">',
    '                        <DataGrid.Columns>',
    '                            <DataGridTextColumn Header="Name"',
    '                                                Binding="{Binding Name}"',
    '                                                Width="100"/>',
    ...
    '                                  SelectedIndex="{Binding Record.Type.Index}">',
    '                            <ComboBoxItem Content="Internal"/>',
    '                            <ComboBoxItem Content="Payout"/>',
    '                            <ComboBoxItem Content="Residual"/>',
    '                            <ComboBoxItem Content="Unspecified"/>',
...
Class cimdbExpenseSlotItem
{
    [Uint32] $Index
    [String] $Name
    [String] $Description
    cimdbExpenseSlotItem([String]$Name)
    {
        $This.Index = [UInt32][cimdbExpenseSlotType]::$Name
        $This.Name  = [cimdbExpenseSlotType]::$Name
    }
    [String] ToString()
    {
        Return $This.Name
...
Class cimdbExpenseSlotList
{
    [Object] $Output
    cimdbExpenseSlotList()
    {
        $This.Refresh()
    }
    [Object] cimdbExpenseSlotItem([String]$Name)
    {
        Return [cimdbExpenseSlotItem]::New($Name)
    }
    Clear()
    {
        $This.Output = @( )
    ...
    Refresh()
    {
        ...
        ForEach ($Name in [System.Enum]::GetNames([cimdbExpenseSlotType]))
        {
            $Item             = $This.cimdbExpenseSlotItem($Name)
            $Item.Description = Switch ($Item.Name)
            {
    ...
    [String] ToString()
    {
        Return "<FEModule.cimdb.Expense.Slot[List]>"
    }
}
...
Class cimdbAccountSlotItem
{
    [UInt32]       $Index
    [String]        $Name
    [String] $Description
    cimdbAccountSlotItem([String]$Name)
    {
        $This.Index = [UInt32][cimdbAccountSlotType]::$Name
        $This.Name  = [cimdbAccountSlotType]::$Name
    }
    [String] ToString()
    {
        Return $This.Name
...
Class cimdbAccountSlotList
{
    [Object] $Output
    cimdbAccountSlotList()
    {
        $This.Refresh()
    }
    [Object] cimdbAccountSlotItem([String]$Name)
    {
        Return [cimdbAccountSlotItem]::New($Name)
    }
    Clear()
    {
        $This.Output = @( )
    ...
    Refresh()
    {
        ...
        ForEach ($Name in [System.Enum]::GetNames([cimdbAccountSlotType]))
        {
            $Item             = $This.cimdbAccountSlotItem($Name)
            $Item.Description = Switch ($Item.Name)
            {
    ...
    [String] ToString()
    {
        Return "<FEModule.cimdb.Account.Slot[List]>"
    }
}
