...
Skit [~] You cut some dude's phone line...?
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
[Cop] : What the actual fuck, dude...?
[Me]  : What...?
[Cop] : So you fuckin' cut some dude's phone line, didn't ya...?
[Me]  : Well, yeh.
[Cop] : Yeah well, why the hell would you do something crazy like that...?
        You done messed up [A-A-Ron]...
[Me]  : It's cause I was trying to call (911).
[Cop] : *rolls his eyes* Buddy, everybody tries to call (911).
...
- [hand an iPhone 8+] that is [infected] with [PHANTOM] that has [evidence] on it, to an [officer of the law]
  for instance [SCSO Scott Schelling, in SCSO-2020-028501]
...
- the [Times Union (04/2006 → 04/2009)] for 
  [Q121/Clifton Park - Halfmoon (12065)], 
  [Q122/Mechanicville (12118), Stillwater (12170), Round Lake (12019), Malta (12020)], and 
  [Q107/Ballston Spa (12020) AKA “northern part of the county”], 
- pizzas for [Pizza Works/Ballston Spa (AKA “northern part of the county”)]
- the [Metroland/Saratoga County], which went to [South Glens Falls] and even [Lake George].

Here's a link to my [resume]. I have had [MANY OTHER JOBS] that are NOT listed on it.
https://github.com/mcc85s/FightingEntropy/blob/main/Docs/2022_1010-(MCC%20Short%20Resume).pdf

[South Glens Falls] is the most northern part of [Saratoga County].
Way more north than [Ballston Spa].

I remember delivering the [Metroland (01/2007 → 01/2014)] for [Lou Comm./Stephen Leon/Ted Etoll],
and having to drive up [Route 9] from [Saratoga Springs], stopping at the [Wishing Well Restaurant].

Every week, I'd get to where [Ballard Road] is, and see [McGregor Correctional Facility] on the
face of the mountain there, and that is when I said to myself... “None of my phone calls are 
going to work around here...”

But, na. Not me, man. I've never tried to make phone calls in the [middle part] of the county.

========================================================================================
| Place         | Delivered   | at...               | for...               | in...     |
|===============|=============|=====================|======================|===========|
| West Milton   | Times Union | Stewarts            | Hearst Corporation   | 2007-2009 |
| Ballston Spa  | Times Union | Many places         | Hearst Corporation   | 2007-2009 |
| Ballston Spa  | Metroland   | Many places         | Lou Communications   | 2007-2014 |
| Ballston Spa  | Pizzas      | houses + businesses | Pizza Works/Scarrano | 2011-2012 |
| W. Charleton  | Times Union | A convenience store | Kris Wacikowski      | 2007-2009 | 
| Moreau        | Metroland   | Wishing Well Rest.  | Lou Communications   | 2007-2014 |
| S Glens Falls | Metroland   | Rock Hill Bake Shop | Lou Communications   | 2007-2014 |
========================================================================================

[===========================================================================================================]

__________________________________________________
Skit [~] Free Cookie Showdown, Rock Hill Bake Shop
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
Every week in [Moreau], this dude at the [Rock Hill Bake Shop] would give me a [fresh chocolate chip cookie].
Dude made damn certain to give me a cookie every single time that he saw me, did that for (7) years.

It didn't start out, being the [free cookie showdown]...

[Dude]: Hey dude, I'm part of a team of people who make the best friggen chocolate chip cookies around.
[Me]  : Oh yeh...?
[Dude]: Yeh. 
        We do not play games around here.
        You want a cookie...?
[Me]  : Uh- sure.
[Dude]: Here ya go, dude.
[Me]  : Thanks, dude~!
[Dude]: No problem.
[Me]  : Have a good one~!
[Dude]: You too, dude.

But eventually, it became the [free cookie showdown]. Sometimes, he'd be busy, talking to a customer. 
I'd come in, and that's when he would be see me...

[Dude]: There he is, the paper guy...
[Me]  : Oh, you know me... just, droppin' off the papers.
[Dude]: *sly smile* Got ya covered, dude.
        *grabs the cookie* Free cookie.
        [Boom].

Sometimes I would see him being in the middle of something, and try not to distract him.
[I knew the cookies were good].
But, this dude didn't play games.

We eventually started having this [free cookie showdown], at the [Rock Hill Bake Shop] in [Moreau].
Dude made damn certain to [practically chase me down], too...

[Dude]: What the hell, dude...?
        You BETTER take this free delicious cookie~!

The moral of the story, is that I never objected to the [free cookie showdown].
...
While the cell service DOES suck ass in [Ballston Spa] and [West Milton], (3) towers were within a mile of 
...
Some people might argue, and say [If you were smart, you'd be rich by now].
But- do you know what type of people say stuff like that...? [Careless morons].

[Intelligence] does not equate to [financial success].
You can be a [total fuckin' moron], and [become a financial success].
Take a long hard look at [Bruce Tanski].

The other argument is this...
Each of those entries up above are a sort of [RARE CURRENCY].

And, that is why I continue to suggest that there's a really long list of people who have ALL been rather 
...
[CIA/Central Intelligence Agency] ... operating domestically
...
[NSA/National Security Agency] ... operating domestically
...
If a guy is [scared] about [me] being on [his property] and has a [baseball bat in his hand] that he grabbed
out of [fear], why didn't [he/his family] call 911 on [me], instead of [me] being the [guy that called 911]...?
...
Another explanation, is that [FACEBOOK HAS BEEN ALTERING PEOPLE'S DATA], [PARTICULARLY MINE]. 
...
What [Facebook] has been doing to me is similar to [taking a baseball bat], and [breaking my legs]. 
Then [when I call the police], they will literally do the same fucking thing that they did on 
[June 13th, 2020], when my neighbor literally attempted to hit me with his baseball bat... 
...they will say "it's ALL in your head."

If it was [all in my head], [why did I call the police]...?
OoOOOooHhhhHhhh... It's cause [many of the police are careless morons].
...
would be [correctly categorizing] any of that footage that they'd be saving...
...
   - OOooooOHhhhh, well, the [answer] is because [someone important] made a [conscious decision] to 
     [expedite her story], because she was a [beautiful young white girl] that [everyone] would have 
     [empathy] toward, for being as [beautiful] as she was. She admittedly WAS a good looking girl.
...
     [what THEY think is NOT important]. This process [illuminates bias], and...
     ...[every single news company does this].

   - They are [very selective] about [what they allow to propogate their system], and they have 
     [caused the average citizen] to think that it would be [ridiculous] for [anybody] to make 
     [direct comparisons] between [them] and [Russian State Media], or even [Chinese State Media].

   - In other words, they channel [propaganda] in many cases, by [filtering out] the things they would 
     [rather keep quiet]... ESPECIALLY if it's [someone who owns the media, police, and justice systems], 
     and they have access to [dangerous (espionage/surveillance) tools] like [Vault 7], or [Phantom/Pegasus],
     or things that the [Central Intelligence Agency] would be able to SELL to the highest bidder... 

     Which means that [some people] are [immune] to things called [laws], and when they do this, they cause
     people to [never suspect] that they [intentionally prevent certain topics] from being on the [news].

   - So if some [comprimised individuals] in the [US Federal Government] had my [iPhone 8+] hacked with a
     dangerous program called [Phantom], and with this program, they attempted to murder me outside of
     [Computer Answers @ 1602 Route 9, Clifton Park, NY 12065] on [05/26/2020], prior to [SCSO-2020-028501], 
     then the story that SHOULD be on the news will [never] make it's way to peoples eyeballs. 
 
     As a direct result of this [intentional content (selection/filtration)]  process, if they continue to 
     do this [repeatedly], then people will think my real life story is [bullshit] since they're not making
     an effort to cover it. If anything, [they work exponentially harder to avoid talking about it].

6) When you're [intelligent] like [Noam Chomsky] or [myself], you'll become a [target].

7) People seem to think that [if you have a lot of money], then it is because someone
   [rightfully earned all of that money], and [didn't commit any heinous crimes] or [anything like that],
   in order to obtain it...

   But- the truth is, [a lot of rich people] and the [police] commit [more crimes] than the [citizens] do.
   It's just that they're [never going to BROADCAST those details], nor will they [hold themselves accountable] 
   for those things.
...
to [tell the girl] that she's got a [poop/period blood] stain on her skirt.
