<#
    ...
    //¯¯\\__//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\\___    
    \\__//¯¯¯ [FightingEntropy(π)][2023.4.0]: 2023-05-15 17:21:38                                            ___//¯¯\\   
        ...
        [Object[]] GetManifestList([String]$Name)
        {
            $List = Switch ($Name)
            {
                ...
                Function
                {
                    ...
                    ("Get-FEModule.ps1"                , "778D407C1E84164989DF106436151E9317EAB0CC7B7EF1231BBFA66AB1C1CCBF") ,
...
/¯¯¯¯¯¯¯¯¯¯¯                                                                                                             
    ...
    | Michael C. Cook Sr. | Security Engineer | Secure Digits Plus LLC | 2023-05-15 17:21:38 |
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯               ___________/
