...
I have [asked myself] a [number] of [questions] as to [why] people [make] the 
[decisions] that they [do]... in reference to uh- [money], specifically. 
...
And uh- [me] and [my father] weren't gettin' along in the months
leading up to his death...

I'm not gonna [elaborate] on [that], [specifically] in [this recording],
but what I [will] say, is this, right...? Um...
'@)
...
is that the [main motivation] behind what happened...?

Because I know that [most people in society], they're gonna
[say] that [money] is the [most motivating factor] for [anybody].

However, um...
[There are higher motivations than that].

And, uh- [money] is basically just a [token] that [allows people] to
[transfer], um... ya know, their [tokens of appreciation], or, or whatever...?
'@)
...
that [IS right], [become wrong]... 

And the [same question] can be [applied] in the [reverse direction]- 
At [what point] is something wr- can [something wrong]-
be [considered right]...?
'@)
...
like- the [facts]. 
Or even in some cases, the [evidence].
'@)
...
Uh, she was also like a [Senator] for [New York],
...
Um, it [requires a bit of explanation] that you don't really get, when you 
like, watch the news...
...
Right...?
And uh- I'll even throw in uh- [snopes.com]
...
[consistent enough], to where their [reputation] is still gonna get a
thumbs up by, universally uh- practically uh, [universal acclaim].
'@)
...
likeable guy, to basically [everybody].
'@)
...
But at the same time, I understand like, he's worked with
[shady characters].
'@)
...
Right...?
The [death] of my [father], caused me to [repulse] the [idea] of
[money] being the thing that [motivates me] to [do] what I [do],
or [think] the [way] that I [think], but [most people] in our [society]...?

They revolve- the [entire thing] that [they] think about,
or [what motivates them]...? Is, [dollar signs]. [Dollar signs]. 
Is what causes-
It's [what motivates most people].
'@)
...
And like, I've made [so many observations] that [most people] would
[never pick up on], because- like, [they're controlled] by this [concept]
of like, [money] and like, being [more important] than one another.

And like, uh- ya know, uh- [having things] to [show] for [their success]
...
like, [jewelry on their teeth] or whatever...

And it's... [really stupid looking]...?
Right...? But- they're [rich].
They are [stupid rich].

I don't know how much [money] they have, but- ya know, 
[a lot of people in society]...? They [envy] them.
'@)
...
And like, they can literally just uh- ya know, 
[+] [take piles of cash],
[+] [throw it in a dumpster], and
[+] [light it on fire]...?
...
[Most people] will [freak the fuck out].
...
of those [dollars]. But I mean, like, [further to that point], like, a
lot of what backs- uh, our [money system], is [bullshit].

Which is why I spoke about [fractional reserve lending].

Right...?
[Fractional reserve lending] is an idea that like, 
our [monetary system] is [overprovisioned].
'@)
...
So like- he- he kept [telling me] that I was like an [idiot], 
to [describe it] the [way] that I was [describing it], or that like, 
I didn't [describe it] the [way] that [he understood it].
'@)
...
And he can basically tell people to, to [eat a dick], if need be...?

And that's the idea of uh- like keeping uh- [security].
Ya know...?

[Security] involves like [weapons], and [tough guys].
'@)
...
Mind meaning though we're in the [modern age] now, where [security] has
taken on a [totally different context], um...

But uh-

Anyway, uh- [suppose] that uh- somebody that uh- wants to [trade] like, 
some of the [gold] that they [gave] to the [blacksmith], uh- for like,
I dunno, like a [horse and carriage] or something...
'@)
...
And then they would take- the [person] would [take the gold],
and [bring it back] to the [blacksmith].
'@)
...
And then you [blow it into the balloon], and then the [balloon] it-
it [takes up a lot more volume]... because it [expanded].
...
Thinking about how uh- this applies to... like uh- [my father] being
[killed] when I was 10 years old...?

Uhm, I think that there were [other motivating factors] for [my father]
being [killed], and... that [those motivating factors] had [very little]
to do with [money].
'@)
...
They hate to say this [out loud], like:
...
Uh- it's not unlike uh- the [hot air balloon]...?
Or, the- the [balloon] with the [hot air] in it...?
...
Right...?
And then you say like, uh-
[You]: Nah, look [I know what my rights are], 
       and basically, you're [not obeying protocol]...?
...
[daddy], [hand down their riches] to their, [ignorant children], to give
them [more control]. 

So if you like, [embarrass them] or [humiliate them], they will use [mommy]
and [daddy]'s [money vault of doom]...

...to be able to [force] their [will] upon [other people].
...
uh- [police officers] over, and over, and over again, [UNLESS]...

Like, they [repeat] this [behavior].

By making some of these [audio recordings], I can uh- [detail an account]
for [things] that have [happened to me] in [my life], because I know that
like, [no matter how many recordings I make] of the [police], and- uh- 
sounding like...
'@)
...
[People]: Yeah but [you're not a police officer], 
          so, [you can't possibly be correct about any of that]...
'@)
...
[drop their guard], and to think that like, [you need to have more money]
...
They [encourage] this [behavior], too.

Which is [problematic], because then it [causes] this uh- this uhm,
...
No- they don't-
They wanna [prevent anybody] from [poppin' that balloon] open.
Ya know, not unlike how like a [cell] when it divides, like uh- when [cells]
are [reproducing], they [divide] right down the middle and stuff, right...?
'@)
...
So, um, the [entire world] would [devolve into chaos] if the 
[monetary system] did fail...
...
Right...?
And then when they do, they'll find out that like, hey, the house...?
...
And they'll have like a [house warming party], 
or like a [christening party], or whatever...?
...
[Bruce Tanski] builds a [(600,000) dollar house] across the street,
and then the neighbors are like:

[Neighbors] Hey, hey, look at our brand new [(600,000) dollar house]~!

And then like, the people that bought the [(400,000) dollar house],
they're like:
...
[600K]: Yeh, uhm, nah nah, it's just your opinion that the s- our house,
        looks, stupid, compared to yours.
        Ya know, your house, it- it looks [cheaper].
'@)
...
Right...?
And then so like, people will [keep these things inside], right...?
...
[inspections], and like making sure the [engineering] and [blueprints] are on par,
or snuff or whatever...?
...
Right...?
Then they can [start bragging] about how much their house costs,
...
Well it's because, [a lot of cars are made to break down], 
they're [engineered] to [break down], so if you [spend more money]
on a [vehicle], they will [engineer it better].
...
But- those [paintings] are prolly gonna stick there- [stay there]
for a while.
...
And they'll be like:
[Someone] : Yeh yeh yeh, [I wanna buy the painting].
            [I wanna buy the painting].
'@)
...
Because [somebody] put [a lot of time and effort] into [making] that
[painting].

And, what I can say, [further to that point], is that [somebody] put
more [time] and [effort] into that [painting], than some of these [cars]
that like [GM] makes.
...
than to  like, uh- [increase] the [value] of the [things] that they're 
[doing].
'@)
...
[house] gets the [value] that it [does].

Or why, uh- a [vehicle] will get the [value] that it does.
Right...?
'@)
...
Wi- with a house...?
Uh, you'll get someone who comes, and they give the house an [appraisal].

And [it costs money] to have them [do] this, they need to [spend] 
a [fair amount of time] being able to [do] it... and uh- typically, 
if you invite a [house appraisal]- uh- [appraiser] to a house that's like, 
not [picture perfect], or whatever...?
'@)
...
They'll be like: 
[Appraiser]: Oh, uh- ya know, uh- I think that uh- I uh- I think that...
...
But like, then somebody who's like, [really smart]...?
Like uh- had their [father murdered] when they were a [kid], who like, 
continues to [make a bunch of content], where he [sounds very sophisticated],
and he's trying to [educate other people]...

Well, [for whatever reason], our [society] will [still give preference] to 
the [idiot] who [owns a whole bunch of property], over the [person] that sounds
...
with the [whole show], because like, [some people] have [something] to 
[show] for like, what they've [worked for]...?
...
The reason being, is it gives them [ability] to uh- [earn] uh-
[interest] on the [principle balance].
'@)
...
a [number] of [illusions] at [play], where... like- [some people] that are
[rich] or [powerful] or [wealthy], they want like, [obedient servants] to be,
uh [paid for their hard work].
...
[Manchin]: I don't want the [student loan] thing, at all...
           ...
           Nah, I'm gonna- I'm gonna work [really hard] to [prevent that] from 
           [making it in].
...
You can sort of like, uh- [aggregate] like, ok...

If uh, there's an [investor] out there, or [some rich billionaire] that
[doesn't like the idea] of [student loan forgiveness]...?

And uh- [Joe Manchin] [doesn't like the idea] of [student loan forgiveness]...?

That like, uh- maybe uh- it's worth [researching] whether or not that
[rich person] like, had anything to do with [Joe Manchin] getting into office, 
...
they're all [paid their salaries], right...?
...
that they all like, [violate people's rights], or they like,
[manipulate the system] or uh- the [politics], politi- [politics] all that much.
...
And like, [they're sort of people] that would like, be cool with uh- the idea of
uh- [all (50) states] making [parts] for the [F-35]...
'@)
...
[suck on SOMEBODY's fuckin' teat] somewhere...

Right...?

And, uh- [I'm not against the idea of money], what I'm [against] is like,
how like, the [idea] of [money] causes [certain people] to [think of like]...

...[stupid fuckin' shit] to [stay rich], or to [get rich], and [screw over] as 
many [people] as they can...

...as long as they do it without them [knowing] that they're [screwing them over]... 

...or if they [DO] know it, like uh- they have to like, they have to [sign] the
[dotted line], and like uh- [hit the checkbox], or whatever.
'@)
...
There's [a lot of things that happen in life] that are [unexpected], right...?
So, this happens to [most people] and it's why [a lot of things are risky].

There's [no way] to [guarantee] really anything, that [involves some level]
of [risk]... Right...?
...
Uh- how like uh- so, [people] will [insure], like uh- the [student loan]
company, and it wi- it will basically- they- [the companies] and the [people]
that [place their bets], they [place bets], right...?
'@)
...
They're gonna [take on] this [added debt responsibility], but they're not 
gonna get like, much in the way of like uh- [compensation] for all of their
[hard work] or their [trip] to [school] or whatever, right...?
'@)
...
Basically it's like a [residual], it's like [residual income].
'@)
...
Uh- they're [able] to uh- [place bets], on whether [some individual]
will [finish school] and [finish paying off their loans], or... 
[whether they won't].

And uh- the [way] they [have] it [set up], is that it- it's not unlike
[car payments] and their [cars] being- people's [cars] being [repossessed],
and the [banks] having to like, [recoup their money] somehow...?

And like, the [insurance comapnies] also getting involved in this...?
Right...?
'@)
...
the [payment of their loans] and stuff...?

They're not gonna get that [interest anymore] if the [loans] are [forgiven].
'@)
...
And then you gotta turn into [Super Sonic], and you got the blonde hair, 
you're not the [blue hedgehog] anymore...
...
in one of his stupid fuckin' machines and stuff... 

And then, uh- then you go onto the [next stage], then you do this
for like, ya know, [(12) stages], and then on like the last few
stages...?

You have like uh- like a [THIRD stage]...
So like, the [second stage] becomes like another stupid robot...?

Maybe the [same stupid robot] that you beat in the [first stage], 
again...?

And then, uh- the third...?
Uh- the third one, then you finally fight [Dr. Robotnik], 
and he'll be like:
[Dr. Robotnik]: Ha ha ha, you're fucked now, [Sonic]...

But, you're [Super Sonic], so like, you can literally just fuckin'
jump around like a fuckin' nutcase...?
...
And, then [his robot falls apart], and then, like, he might like,
[run off like an idiot], or he might like uh- get like, into uh- 
his uh- [doom ship].
'@)
...
From [Sony Playstation]. (...[Crash Bandicoot]...)
...
Is like, they really set up a lot of [complicated things], 
that [most people] are gonna [fail] to be able to [do],
...
You might be [better off] just playin' the fuckin' game [Sonic the Hedgehog 2]...
'@)
...
So basically, what causes [some people] to [become more rich], is uh-
...
But- ya know, uh- [that doesn't necessarily mean that], uh-
'@)
...
[there's a lot of people] that like uh- they [build] a [house] and then the
[house] gets like, uh- [repossessed]...?
'@)
...
And so, the idea behind like, uh- [collateral], is [pretty important], because
like, you [need] to [have enough collateral], in order to like, [convince]
somebody to like, [place a bet], and [see the odds] as like, ya know, 
[in their favor].

Because if the [odds] are [in their favor], and then they [win out big time],
you can [bet] your [ass] that [they're gonna fuckin' go ahead and bet],
[very easily].
...
Do they send a [team] of [hitmen] with [rifles] and [knives] to like,
come like, [gut you like a fish]...?

Well, [in some cases] that'll be the [military] that does that.
'@)
...
[police officers] to like, [smear] somebody's [record] a [thousand times], 
instead of like uh- [doing their job correctly].

And what they'll do, is they'll [drag their feet]. 
And, it'd basically be like uh- ya know, uh- like a [full-grown man],
going to the [island] with a [bunch] of [kids] in uh what was it, uh-
...
and [all these kids] on the [island] are tryin' to [tell you what to do],
or whatever, and you're like:
[You]: Nah, dude...
       Uhm, ya- just [shut the hell up]...?
       Heh.
       You do what I tell ya to.

And it's like, they're like:
[Kids]: Nope, that's not how we do things on the island of [Lord of the Flies].
...
[Start]    : 19:17:16
[Duration] : 00:07:28
[Link]     : https://drive.google.com/file/d/1CvP8z-AsrOUFZTV4J5Yg2Y5afkMvEmZP
'@)
...
in the [gov't], and they have [honest people] in the [gov't], too.

They also have some like [incredibly] uh- [douchebaggish people] in the [gov't].
They also have some [very dangerous people] in the [gov't].
...
have [more integrity] than like, [a lot of people in society]...?
...
[Our entire society] is [full] of [people] that uh- they- they [mix] and
[match] like uh- [what their values are].
'@)
...
But also like, [how much time] they [put] into [developing] the [skills]
to be able to [envision] the [idea] within the [painting].
'@)
...
And on the [surface] of the [water] you could [see] a [reflection] of like
uh- uh- a- the [sky], or the [trees] and stuff...?
...
Right...?
And uh- ya know, [owning a house] costs [money], so it's not just [paying]
for the [house itself], but like it also uh- can- it also uh- [requires] like,
[maintaining the house], and uh- [keeping it in order], and uh- there's a [lot]
of [money] that [goes into being a homeowner].

But- ya know, once [somebody] is [stuck] within a [home], and then you try 
to like, uh- do the same thing that [Morpheus] does to [Neo] in [The Matrix], ya
know, [some people] will [realize]: "Holy fucking shit..."

...when they're [knee deep] in the [middle] of a [car payment], or a [student loan],
or a [mortgage], or a having some level of a [repair] or whatever done...?
...
do [everything I've explained] in this [whole audio log].
'@)
...
to where they have to [make certain assumptions] as to [what] they're
being [educated] about.

So like, if somebody's who's [good looking], and uh- ya know,
[liked] by a [lot] of [other kids] in their [class]...? 
...
they were like:
[Someone]: Hey.
           How would you like to, ya know, be [freed] of the
           [chains of humanity]...?
...
[Someone]: Freed of the [chains of humanity] means that like, I'm gonna throw
           ...
           worry about paying a [mortgage], or a [car loan], or uh-
...
in this [really cool car] all the time...?

He's got a [(400,000) dollar house], or a [(600,000) dollar house],
and like uh- ya know, like, he has to [keep up appearances], and like
if he [ever] comes across [somebody] as [intelligent] as like, 
[Michael Cook]...?

He's gonna [run his fuckin' mouth] and say:
...
Ya know...?
They'll say "No, I definitely have control over it..."
...
mainly because, like [at some point], uh, the [power-] uh- [grid],
as well as the [telecommunications grid], [at some point] in the
[future], these things are [gonna be free again].

They're go- [there's no way around it].

It [WILL] be [free], [power] will be [free],
you'll be able to [heat your home] and [power your home],
with [solar energy].
'@)
...
why the hell isn't my [power] lasting an [entire day]...? 
Or an [entire week]...?
Or an [entire month]...?
'@)
...
their [gas tank] has a [hole] in it, no way dude.
...
[another shit car]...?
That just [suddenly stopped getting] the [mileage] that it was 
[supposed to get]...?
Or, what was advertised...?

Or, some [shady trollmeister] somewhere, like, they [turned a knob] in the
[engine compartment], so that the [engine] runs a [little more rich], and
then it [burns through the gasoline a lot faster].
'@)
...
[Northstar]: Oh yeh, the car had all these problems, right...?

And then, they fixed all [those problems], but-

[The problem that you brought it there for]...?
...
the car to the moon, with that fuckin' thing.

But, you know uh- [General Motors] [designs] their [vehicles] to [break down],
and uh- ya know, there are [so many things] in our [society] that are [designed]
to [break down] and [produce waste], because...

[Waste] puts [money] into [certain people's pockets], 
and it [takes opportunities away] from [other people].
'@)
...
be [quick-witted enough] to [know what the hell's goin' on] right in front
of you...?
...
[They] will [work really hard] to [disillusion everybody] from
[payin' attention] to [somebody] that's [been around] the fuckin' block...?
'@)
...
and then it will like, [spray out all over the inside of my backpack], which-
ya know, makes me [smell]- makes my [backpack smell] like uh- [cologne] or
[body spray] for a while, right...?
'@)
...
[Me]: What the fuck...? 
      Ya know...?
      How the hell did it get through the bag...?

Ya know, [here's the best case that I can make].

When uh- [dogs] or [canines] that [work] for the [police], they- they [smell drugs]
and stuff...? It works the same way as like, [detecting bullshit] that people say.

Right...?
Uhm, like the [smell permeates other substances], and it [carries forward] like
...
or it'll be like uh- what the hell, uhm, [plastic]...?
...
[single that person out], if they're [not playing along] with the, the [game]
that [everybody else is playing].

Right...?
And then, like, [everybody] will [work against] this [(1) person], 
...
[Jesus Christ] like, often [prophesized] about this, like uh-
[possessions are chains]. Ya know, having [some possessions] isn't like,
...
And [you wanna know why people do that]...?

It's because [people] are [stuck] inside of like, a (30) year mortgage,
where they have to make it an entire (30) years, so they can "own" their 
house for like (10) years while they're [retired].

Yeh.
So like, that's how it is, it's like...
'@)
...
And then like, oh, at some point, oh.

They- [they can't work anymore], so [they gotta retire]...?
So, [did they save up for retirement], too...?

Oh, [they saved up for retirement too], oh, [good].
[Ok].
[Good].
So like...
'@)
...
amount of like, [leisure] they have when they're [that old]...?

...is uh- [going to the library].
Yeh.
'@)
...
[Them]: Holy shit.
        That dude [Michael Cook] was onto something,
        [why the hell didn't I listen to him]...?

Nah, here- [here's the reality].

[Some people] um, they're [gonna get ahead of all these things], and the [way]
they're gonna [do it], is by [listening] to [guys] like [Jeremy Rifken] FIRST, 
ya know...?

[People aren't gonna wanna listen to a lot of the things I say FIRST],
I understand that.

But, ya know, in order for me to be [taken seriously]
from now until the [future]...?

Um, [people] have to [understand] that at [some point],
[our system is gonna collapse].

It's not unlike how uh- uh, [Rome collapsed], or uh [Greece collapsed]. 
The [Roman Empire]...?
...
[seeing is believing], and then like, but- [they don't tell each other], often
enough, [but appearances can be deceiving].

So what I mean specifically, is like this...

You know, behind [door number (1)]...
Behind [every door], there's gonna be a [hot girl], where you can
[have sex with her], and [have a bunch of kids].

But- they all have a [varying alternate attribute].
Right...?

Behind [door number (1)]...?
Is the [hot-dumb bitch].
...
Then uh- you don't know if you're gonna wind up [getting divorced]...?

Or, if your [mortgage] is gonna [fall apart halfway through]...?

Or if she's gonna like, [try to stab you to death]...?

Ya know, [these] are [things] that you're [not gonna fuckin' know about]...
...um, [other] than the [fact] that [she is fuckin' dumb].
'@)
...
She's [very loyal], [very obedient], and uh- [she's got a lot goin' on for her]
other than (just) her [looks], and uh- she isn't- thing is, is like, 
[she's not gonna tolerate being lied to].

[You need to consistently tell her the truth], [at all times]...?
And uh, [in exchange for that], [she] is [gonna be yours].

And you can have a [LOT] of kids with this girl, too...
'@)
...
And, [door number (3)]...?
You've got the [mixed bag]...

You've got the [hot-crazy wife matrix of doom], shit...
'@)
...
Or it could be some [hot really smart bitch]...
It could be, uhm, [hot-dumb-loyal]...?
Or, [hot-smart-loyal]...?

Or, [hot-dumb and NOT loyal]...
Or, [hot-smart and NOT loyal]...

[Because all these properties matter].
Right...? (This is all a metaphor for the Punnett square)
'@)
...
So if like, [most people in society], they just like, fuckin' uh- 
[hook up] with the [first girl] that they [see] all the time...?

They're not gonna be able to [understand] whether that like,
[decision] that they [make] in [one day]...?

Is gonna [alter] their [future] in [(15-30) years].
Ya know, like um-
'@)
...
So, all these things that I've said, [they don't account] for like uh- the
[regrets] that [people have], [later in life].
'@)
...
and [pay off their house] and everything, but- 

You know what...?
They're like, [upset with themselves], because they [realized] that if uh- 
[they made] a [couple of other choices] that [weren't so risky]...

They could've uh- had a [plan for success] that [didn't involve screwing other
people over] or [lying to them], but it [involved] just [manufacturing something]
that was uh- gonna [produce a lot less waste], that was gonna be uh- [renewable]...?

And it offered some [smart ways] to [improve] their [quality of life]...?
'@)
...
The [future holds] like, the [idea] that uh- [humans have to be more resourceful],
[less wasteful], and uh- to uh- to [start to filter out] what [properties] they
[believe] and [don't believe].

And what- [from what I can tell], like there's a [lot] of [people] in the [gov't] 
that like, continue to be [lobbied] by [some rich bastard] who's [corrupt].
'@)
...
Nah, there's a [reason] why he's [sayin'] he [doesn't like] the [way] it [looks].

It's because a [lot] of [people] all around the [country], that have been 
[giving], that have been [sucking off] of like, [somebody's fuckin' teat]...?

Ohhhh, [they don't like the idea] of the [teat] being [taken away forcibly],
and so [what they're gonna do], is they're gonna use [every fuckin' tool] at
their [disposal], to [continue being like the slave masters back in the 1800]'s.
'@)
...
Right...?
A [lot] of [people] in our [society], they don't [realize] that like, [they] 
operate [exactly], in a [nearly identical way] to how the [slaves] used to
[operate]. 

Except, the way that it's [different now], is like, instead of [slaves]
workin' for [free], they're getting like, [paid], and they get [housing] and 
everything...?
...
the [every-day, ordinary citizen]...?

But- [I'm pretty sure that they don't], because, you know, [situations] like
[Richard Sackler]... [Richard Sackler] can like, uh- [make this drug] that is
[very addictive], and it [got a lot of people addicted], it got a [whole industry]
like, screwed up...
...
There's [a lot of people in the government] that do that shit.
For [Richard Sackler].
They'll [jump in front of a bullet] for [Richard Sackler].
Or, [maybe they won't]...

Ya know, they'll be like:
[Them]: Well, I wouldn't [jump in front of a bullet] for [Richard Sackler], but...
        Ya know, if he's gonna throw me a stack of [(50,000) dollars]...?
        [I'll fuckin' take it]...
        And then uh- I'll just [tell] like, [everybody] that [tries] to [attack]
        [Richard Sackler] to [fuck off]...
...
[ammunition], to like, [keep himself] like [protected]...?

Ya know, he's not gonna be- [people] aren't gonna [think well] of [Richard Sackler]
for the [forseeable future], but ya know, [his life], uh- it's [protected].

Right...?

[A lot of people work to protect him], and uh- ya know,
[a lot of people in the government], have worked to uh- 

Effectively what I'm [alluding to] is this, like, 
...
[You]      : Would [you] [suck some dude's dick] for a [million dollars]...?

And then like, ya know somebody might say:
[Somebody] : Yeah, I'll do that.

And it's like:
[You]      : Well, what if I record it on video...?

Then they'll change their answer, and be like:
[Somebody] : No no no, no no no, [not if you're recordin' it on video]...
             ...then I wouldn't.
             Nah nah nah, I wouldn't suck-
             [Wouldn't suck some guys dick] for a [million dollars] if uh-
             you were [recording a video of it]...
[You]      : Well, why not...?
'@)
...
[You]      : Well, why not...?
[Somebody] : Well, [because other people would be able to see me] 
             [suckin' some dude's dick] for a [million dollars].
             And then-
[You]      : Oh, well, but I mean... 
             [Why would that change your mind]...?
[Somebody] : [Because other people would see it].
[You]      : Oh, well, [just because other people could see it], doesn't,
             ya know, well, how, [why does that change your mind]...?
[Somebody] : [Because other people would see it], and they would [realize]
             that [I sucked some dude's dick] for a [million dollars].
[You]      : Oh, so if [other people SEE it], then [you wouldn't do it]...?
[Somebody] : Right.
[You]      : Alright.
'@)
...
And, the [problem] with [humanity], is this...
Right...?

There exists, [a dimension above us], where [all] of the [decisions] that
[we] have [ever made] (or have yet to make), for our [entire life] have 
[already been seen] and [witnessed], and [categorized], and uh- ya know, 
[some people are really stupid]...?

And they think that is [babbledy-gook], and [those] are the [types of people]
that [like to suck somebody's dude's- somebody's dick], for a [million dollars],
[as long as they're not recorded] or [seen doing it].
'@)
...
[Sagan] : You get a bunch of [2D flatlanders], right...?
          And then you get a [sphere], and then you [take the sphere],
          which is a [(3) dimensional object], and then you have to [cut it] 
          into [slices] so that the [2D flatlanders] can [understand] the
          [3D sphere].

          Right...?
          
          And as the fuckin' [3D sphere] passes through the- the [flatlander]'s world...?
          Then uh- the- the [flatlanders] are all like:
          "[Holy shit]~! [What the hell is that thing]...?"

          And then they're like:
          "Holy shit, [that thing] is [fuckin' weird]..."

And then like, you know, uh- [the same concept applies] to how uh-
...
It's not like [every single decision] that [somebody makes], is gonna cause, is gonna
cause someone like [me] to think that [they're fuckin' stupid] for [makin'] that
[decision], knowing that [no one] could [SEE] what they were [doing], and that
[no one] would ever know...

Right...?
But- [certain decisions] that [these people make], cause [other people] to have to
keep [skeletons] in their [closet], and basically like, uh [suck on somebody's dick],
for a [million dollars], and that's-
'@)
...
They're just gonna [keep doin' it]...?
And [no one] is [ever] gonna [stop them].
...
[Someone]: There's [no way] that they would know, that [I made some decision],
           [as long as they didn't see it]...
           
Well, you really don't need to like, be able to [see anything], other than like uh- 
know that the same- the [metaphor] that I r- that I rose earlier, the [analogy] that
I rose earlier, about like the smell...?

Of uh- the [body spray], on my [slice of pizza], from [within the bag]...?
'@)
...
Yeah.
Someone [WILL] know, it's just that like, [your idea] of [knowing] something...?
Is like, basically [seeing] it.

And that would be [knowing] something.

But- [that's just an opinion].
That is just [a fuckin' opinion], dude.
'@)
...
[You]     : [What if I record it on video]...?
[Somebody]: No no no, no no, I would NOT [suck some dude's dick] 
            for a [million dollars] if [people saw it].
[You]     : Oh...
'@)
