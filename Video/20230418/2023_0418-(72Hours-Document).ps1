...
I recorded an [audio recording] at [04/17/2023 23:05:43], and decided to [transcribe it].
'@)

$Doc.Add("File/Party",@'
Index Name Date       Start    End      Duration
----- ---- ----       -----    ---      --------
    0 2023_04_17_23_05_43.mp3 04/17/2023 23:05:43 23:29:17 00:23:40

[Url]: https://drive.google.com/file/d/1_8yH-UvorOx2zi4vbsuxegwUKDH2n9j5
...
$Doc.Add("Transcription",@'
Index Party Position Note
----- ----- -------- ----
0     MCCS  00:00:00 Audio log Monday, [April 17th, 2023].
...
2     MCCS  00:01:59 If they had to care about [every bit] of [evidence] that [proves someone's innocence]...?
...
3     MCCS  00:02:41 Now, suppose that I'm [wrong], and they're NOT committing [obstruction of justice],
                     why is it that [every single time] that I [bring up] the [existence] of the [audio recording], 
                     ...
                     Because, ya know, like uh- [he's made it very clear to me] that the- the details of the case
                     DON'T have to be [discussed] at the [courtroom].
                     
                     What [CAN] be [discussed], is the [punishments] that I'm gonna [undergo].

4     MCCS  00:03:29 Because that's what the ju- that's what the system [FEELS] like doing.
...
5     MCCS  00:04:37 And they don't do this to EVERYBODY, because I think it reall does matter
...
6     MCCS  00:05:04 So what happens is uh- people that are a lot less intelligent than me,
...
7     TXT   00:06:01 ===============================================================================================
    ...
    r, [Dwayne O. Coonradt] at [Computer Answers] can [sell stolen copies]
...
8     MCCS  00:06:01 Are the police gonna go anything about that...?
...
9     MCCS  00:06:50 What [matters] is what they think.
...
10    MCCS  00:07:33 Well, then I'm gonna be- I'm gonna be [sent to jail], for [contempt].
                     Right...? 
...
11    MCCS  00:08:31 And being able to [determine] that like, ya know, [all of my predictions]
...
12    MCCS  00:09:16 That is like, how these people have been [thinking] and [reacting].
...
13    TXT   00:09:50 ===============================================================================================
    ...
    he [body camera footage] proves that [Cameron Missenis] showed up with
...
14    MCCS  00:09:50 What they did was like, every bit of [violation of the law], that I
...
15    MCCS  00:10:27 Uhm- so if I have to like, be [completely honest] and not be like [reverse psychology]
...
16    TXT   00:10:58 ===============================================================================================
    ...
    4/05/22 | Dr. Reilly | https://drive.google.com/file/d/1aNBYW3iBKJ9SkdfnCeL2aTp5oHCXtnqu
    
    A conversation that I recorded speaking to [Dr. Reilly] from [Saratoga County Mental Health]
    about a year before the last appearance I had with [Joe Fodera] on [04/05/2023].
    
    It's interesting, right...?
    I continue to make these [multiple statements] about how some people at [Saratoga County]
    are fuckin' morons... and [they do absolutely nothing to change their behaviors].
    
    Essentially what that is, is me, telling some dude name [Dr. Reilly], that I intend to file
    a fucking lawsuit against [Saratoga County].
    
    Much in the same manner to how the people at [Saratoga Hospital] act, uh- the dude doesn't
    seem to be all that convinced nor really worried about a god damn thing. Why...? Uh- because
    apparently you need to have [money] to file a [successful lawsuit].
    ...
    [This conversation] is the [typical conversation] that [mental health professionals] tend
    to have with me, where I never once had [schizophrenia] for the first (36) years of my life,
    but oh my god...
    
    Shockingly, [once I started my company] and started [doing research] into national security
    programs, and [corruption in the government] and [everywhere else] [breaking laws], and 
    [committing crimes], and [lying to people] unimpeded...?
    
    Oh, NOW I [must] have [schizophrenia]. Yeah. 
    That's the [actual thought process] of this [stupid cunt] at [Saratoga County Mental Health],
    [Dr. Gurbek].
    
    I just apparently masked it incredibly fucking well that whole time.
    Or, [some people are fucking stupid], and they [deserve] to be [shot to death] by a
    [deranged lunatic] like [Stephen Paddock].
    ...
    that I had with [her] and [Dr. Glosman], and when I said "No.", that's when they made the
    decision to [do something fucking stupid].
...
17    MCCS  00:10:58 ight, I'd like, to have the [opportunity], to [show the evidence] to 
...
18    MCCS  00:12:00 I think that uh- like, this [whole process] over the [last few years], has like, 
...
19    MCCS  00:13:25 And then, it's not just the [police], [some of the police] that are fuckin' stupid,
...
20    MCCS  00:13:43 And, uh- ya know, the reason why I'm in the [position] that I'm in, is because
...
21    MCCS  00:14:31 Right, my mother was so surprised, that like I won an award for my writing
...
22    MCCS  00:15:03 I am like, trying to [ridicule] my [mother] to the [worst degree possible],
...
23    MCCS  00:15:40 [Society] is like, uh- [taking advantage of m]e because of [that].
...
24    MCCS  00:16:18 And, uh- ya know, whether it's like a [robot drone/bird] that I recorded in
...
26    MCCS  00:17:33 I mean, that's- that's the [beginning] and the [end] of it.
...
27    MCCS  00:18:09 And there's [a lot of people in our society] that are like [that].
...
28    MCCS  00:18:53 I have a [better relationship] with this fuckin' uh- dude that shows up at the
...
29    MCCS  00:19:33 Uh- uh- all that- all that mu- well...
                     I don't wanna say-
...
30    MCCS  00:20:03 The way that [society] is [SUPPOSED to be].
...
31    MCCS  00:21:17 Meanwhile, fuckin' [Verizon] is making a lot more money off the lines.
...
32    MCCS  00:21:55 Nah, it's like, at some point, some people are gonna hear like, my rhetoric,
...
33    MCCS  00:22:56 For like, you know, [indicating], for [indicating] that like, the [court order]
...
34    MCCS  00:23:37 End log.
'@)

$Doc.Add("Conclusion",@'
I'm not incompetent to stand trial at all, and I predict that there will
be some "unexpected" condition or curveball thrown my way when I go to the
(72) hour observation period.

For instance, they may probably keep me involuntarily until I start taking a
specific medicine, and then apply for DSS and get assistance from the state.

They will do this mainly because as long as they get someone as intelligent
as me to be labeled, that's all that matters.

Because from that point forward, I'll have to walk around with a diagnosis
that isn't accurate, and that'll prevent me from being able to succeed with
my business, nor to make good on my education and investments into the 
programming...

Effectively what this allows is for someone who has a lot of money to have
their way.
'@)
