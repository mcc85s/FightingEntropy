...
Function Get-EventLogProject
{
    ...
    Class ProjectRestore
    {
        ...
        ProjectRestore([Object]$ThreadSlot,[Object]$Archive)
        {
            $This.Time           = [System.Diagnostics.Stopwatch]::New()
        ...
        [Object] NewProgressObject([Object]$Work)
        {
...
$UserInterface.AddScript(
{
    ...
    [Action]{
        ...
        $Sync.UI.Reset($Sync.UI.Throttle.Items, $Sync.Control.Index.Output.Label)
        $Sync.UI.Reset($Sync.UI.Threads.Items,  $Sync.Control.Index.Total)
    ...
    $Sync.UI.Continue.Add_Click(
    {
        ...
        If ($Sync.Mode -eq 1)
        {
            ...
            $Launcher.AddScript(
            {
                ...
                $Sync.UI.Table.Dispatcher.InvokeAsync(
                [Action]{ 
                ...
                $Sync.Window.Dispatcher.InvokeAsync(
                [Action]{

                    $Sync.UI.Browse.IsEnabled       = 0
                    $Sync.UI.Continue.IsEnabled     = 0
                    $Sync.UI.Throttle.IsEnabled     = 0
                    $Sync.UI.AutoThrottle.IsEnabled = 0
                    $Sync.UI.Threads.IsEnabled      = 0
