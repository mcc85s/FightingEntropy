            ...
            If (($Execute.Result | ? RestartNeeded -eq No).Count -gt 0)
            {
                ...
                If ($InputObject)
                {
                    ...
                    $Value = @( 
                        ...
                        'Unregister-ScheduledTask -TaskName FEDCPromo -Confirm:$False -Verbose',
                    ...
                    Register-ScheduledTask -Action $Action -Trigger $Trigger -TaskName FEDCPromo -RunLevel Highest -Description "Restart, then promote system"
                    Restart-Computer
                }
                If (!$InputObject)
                {
