...
Function Get-ThreadController
{
    ...
    Class ThreadSlot
    {
        ...
        IsComplete()
        {
            ...
            $This.Complete = ($This.Thread | ? Complete).Count
...
# // | This is essentially the event log controller, however, it is only doing stuff in the console. |
# // | What is so challenging about this entire process/program, IS NOT this part at all.            |
# // | It probably sounds ridiculous, but I've been stressing over the console output being in the   |
# // | GUI, instead of in an actual PowerShell host/console. The threading dispatcher keeps locking  |
# // | up whenever I interact with several components in the GUI, and they seem to move around...    |
# // | I'll discuss it at length at some other point.                                                |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
Function Get-EventLogProject
{
    ...
    Switch ($Pscmdlet.ParameterSetName)
    {
        0 { [Project]::New($ThreadSlot)                 }
        1 { [ProjectRestore]::New($ThreadSlot,$Restore) }
    }
}

# // __________________________________________________________________________________________________
# // | This is the XAML based GUI that I built, like several months ago... that isn't the hard part.  |
# // | I think I've done a fairly decent job of showing people how consistent my XAML building skills |
# // | are, though to be fair, I've had a lot of ideas with storyboards & themes, that I haven't      |
# // | really touched on yet. Storyboards are basically animations. Themes involve an insane amount   |
# // | of code for such a small reward. I've seen how complex XAML can get when it looks more like    |
# // | Silverlight. That is touching on writing assembly within a chunk of XAML, pretty difficult.    |
# // | By the way, some dude said that I stole some stylesheet code...? I don't know if that dude can |
# // | read, or was just waking up or whatever...? But, I write my own material. Sometimes I may take |
# // | inspiration from another project, like Damien Van Robaeys, and Mr. Niehaus/Arwidmark/Nystrom   |
# // | are about as far as I've really gone in working with other people's projects or ideas.         |
# // |                                                                                                |
# // | I don't use anyone elses colors, themes, or styling. In fact, I even made my own color theme   | 
# // | for Visual Studio Code, and then people occasionally ask me what theme it is.                  |
# // | The point is, I write my own material. MAYBE stealing some stylesheet code from my own Github  |
# // | project is a capital offense, and I didn't even know. THAT MEANS, I gotta turn myself in to    |
# // | the police now, and say "I can't bear the burden of such a shameful, capital crime..."         |
# // | They're gonna be VERY CONCERNED, and ask me what I did. I'm gonna tell em... "I stole my own   |
# // | shit, dude... Some dude on Reddit was telling me that it's basically like treason... and NOW,  |
# // | I just can't live with myself for doin' that."                                                 |
# // |                                                                                                |
# // | That sounds pretty stupid, right...? Well, good. That's what I'm shooting for. That's being    |
# // | dramatic... I realize that many people are gonna get the wrong impression of me. When they see | 
# // | some of my rants or writing, they're not gonna immediately catch on to the notion that I'm not |
# // | just a programmer, but I'm also a fairly prolific author and comedian.                         |
# // | Some people will say "Get a life~!", but, I will spend a good chunk of time writing up skits   |
# // | to make fun of MORONS, who say "OoOOhhHHh guy stole some stylesheet code from some guys repo." |
# // | Yeah, I mentioned at the top of the video that it was my repo. So yeah I stole it from myself. |
# // |                                                                                                |
# // | I'm not quite sure people understand it. There's resistance that I detect, that other people   |
# // | don't, and when I snap at some dude for saying "stolen stylesheet code", then they're gonna    |
# // | think I'm bullying some dude who intentionally said that to play with everybody's head. Like,  |
# // | the dude probably doesn't know how to write his own code. Phenomenal at CTRL+C and CTRL+V.     |
# // | Dude has the most versatile skillset in the world, at pressing those (3) keys.                 |
# // | I'm probably exaggerating... but maybe I'm not exaggerating at all.                            |
# // | Dude says "stole stylesheet code from some dudes' repo"...                                     |
# // | Obviously isn't an idiot, so he knew that I pulled it from my own repo...                      |
# // | But OTHER PEOPLE WILL READ that, and be like, "Wow. What a douchebag that guys is, for         |
# // | stealing his own code..." Anyway, whatever I'm movin' on.                                      | 
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# // | So, this is the class that controls all of those above classes and functions in the GUI.     |
# // | It's... something I've rewritten at least 20 times. The process from beginning to end takes  |
# // | like an hour or so, but that is all dependent on the machine and the number of events in the |
# // | event logs. The cool thing is, it is literally a tool that collects all of the event logs    |
# // | from a machine, compacts it right down, and then it can be imported and exported without     |
# // | needing the WINDOWS SERVICE. There's plenty of other things I could throw into this.         |
# // | Ultimately, this is like a forensic level tool, so if a cybercriminal wants to use advanced  |
# // | tools from the (Central Intelligence Agency/Vault 7), this tool can catch evidence of that.  |
# // | Pretty cool, huh...? A dude made a program that COULD literally catch cybercriminals. Weird. |
# // ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
# Add-Type -Assembly System.IO.Compression, System.IO.Compression.Filesystem, System.Windows.Forms, PresentationFramework
# $Parent = "$Home\Desktop\EventLog-UtilityRunspace"
# . $Home\desktop\EventLogs-UtilityRunspace-v4.ps1
