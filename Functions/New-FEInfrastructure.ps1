...
Function New-FEInfrastructure
{
    ...
    Class FEInfrastructureGUI
    {
        ...
        '                                        <!-- column 0 -->',
        '                                        <Button Grid.Row="0" Grid.Column="0" Grid.RowSpan="3" Name="DsBrCollect" Content="Collect"/>',
        '                                    </Grid>',
        '                                    <Grid Grid.Row="1">',
        '                                        <Grid.RowDefinitions>',
        '                                            <RowDefinition Height="*"/>',
        ...
        '                                    </Grid>',
        '                                    <TextBox Grid.Row="1" Height="220" Background="White" Name="DsBootstrap" Style="{StaticResource Block}"/>',
        '                                </Grid>',
        '                            </TabItem>',
        ...
        '                                    </Grid>',
        '                                    <TextBox Grid.Row="1" Height="220" Background="White" Name="DsCustomSettings" Style="{StaticResource Block}"/>',
        '                                </Grid>',
        '                            </TabItem>',
        ...
        '                                    </Grid>',
        '                                    <TextBox Grid.Row="1" Height="220" Background="White" Name="DsPostConfig" Style="{StaticResource Block}"/>',
        '                                </Grid>',
        '                            </TabItem>',
        '                        </TabControl>',
        '                    </GroupBox>',
