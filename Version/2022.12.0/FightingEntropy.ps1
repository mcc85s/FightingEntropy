        ...
        [Object[]] GetManifestList([String]$Name)
        {
            $List = Switch ($Name)
            {
                ...
                Function
                {
                    ...
                    ("Get-FEModule.ps1"                , "FFF5B7281D040551EC1D5F90F008B9850842A1000D1DED7E4C0E9839B91594B0") ,
...
/¯¯¯¯¯¯¯¯¯¯¯                                                                                                             
    ...
    | Michael C. Cook Sr. | Security Engineer | Secure Digits Plus LLC | 2023-03-28 16:19:54 |
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯               ___________/
