<#
    ...
    //¯¯\\__//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\\___    
    \\__//¯¯¯ [FightingEntropy(π)][2022.11.0]: 11-16-2022 10:47:13                                           ___//¯¯\\   
...
/¯¯¯¯¯¯¯                                                                                                                 
    ...
    | https://github.com/mcc85s/FightingEntropy/blob/main/Version/2022.11.0/FightingEntropy.ps1 |
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
Function FightingEntropy.Module
{
    ...
    Class Main
    {
        ...
        [String] PSM([String[]]$Bin)
        {
            ...
            $F += "# </Functions>"
            $F += "Write-Theme -InputObject `"Module [+] [FightingEntropy())][$($This.Version)]`" -Palette 2"
...
/¯¯¯¯¯¯¯¯¯¯¯                                                                                                             
    ...
    | Michael C. Cook Sr. | Security Engineer | Secure Digits Plus LLC | 11-16-2022 10:47:13 |
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯               ___________/
