...
.NOTES
   ...
   //        Purpose    : For managing the configuration AND distribution of ADDS nodes,                           //   
   \\                     virtual hive clusters, MDT/WDS shares, and sewing it all together.                       \\   
...
Function New-FEInfrastructure
{
    ...
    Class FEInfrastructureGUI
    {
        ...
        '                                        <RowDefinition Height="*"/>',
        '                                    </Grid.RowDefinitions>',
        '                                    <Button Grid.Row="0" Content="+" Name="DcAggregateMoveUp"/>',
        '                                    <Button Grid.Row="1" Content="-" Name="DcAggregateMoveDown"/>',
        '                                </Grid>',
        '                                <DataGrid Grid.Column="1" Name="DcAggregate"',
        ...
        '                                    <Label   Grid.Row="1" Grid.Column="0" Content="[CommonName]:"/>',
        '                                    <TextBox Grid.Row="1" Grid.Column="1" Name="DcCommonName"/>',
        '                                    <Button  Grid.Row="2" Grid.Column="0" Grid.ColumnSpan="2" Name="DcGetSitename" Content="Get Sitename"/>',
        '                                    <Label   Grid.Row="3" Grid.Column="0" Content="[Zip Code]:"/>',
        ...
        '                                <DataGrid Grid.Column="2" Name="DcViewer">',
        '                                    <DataGrid.Columns>',
        '                                        <DataGridTextColumn Header="Name"  Binding="{Binding Name}"  Width="150"/>',
        '                                        <DataGridTextColumn Header="Value" Binding="{Binding Value}" Width="*"/>',
        '                                    </DataGrid.Columns>',
        ...
        '                            <Label Grid.Row="4" Content="[Topology]: Output/Existence validation"/>',
        '                            <DataGrid Grid.Row="5" Name="DcTopology"',
        '                                      ScrollViewer.CanContentScroll="True"',
        '                                      ScrollViewer.IsDeferredScrollingEnabled="True"',
        '                                      ScrollViewer.HorizontalScrollBarVisibility="Visible">',
        '                                <DataGrid.Columns>',
        ...
        '                                            <ColumnDefinition Width="40"/>',
        '                                        </Grid.ColumnDefinitions>',
        '                                        <Label   Grid.Column="0" Content="[Subnet]:"/>',
        '                                        <TextBox Grid.Column="1" Name="NwSubnetName"/>',
        '                                        <Button  Grid.Column="2" Name="NwAddSubnetName" Content="+"/>',
        '                                        <Button  Grid.Column="3" Name="NwRemoveSubnetName" Content="-"/>',
        '                                    </Grid>',
        '                                </Grid>',
        '                                <Border   Grid.Column="1" Background="Black" BorderThickness="0" Margin="4"/>',
        '                                <DataGrid Grid.Column="2" Name="NwViewer">',
        '                                    <DataGrid.Columns>',
        '                                        <DataGridTextColumn Header="Name"   Binding="{Binding Name}"  Width="150"/>',
        '                                        <DataGridTextColumn Header="Value"  Binding="{Binding Value}" Width="*"/>',
        '                                    </DataGrid.Columns>',
        ...
        '                            <Border   Grid.Row="3" Background="Black" BorderThickness="0" Margin="4"/>',
        '                            <Label    Grid.Row="4" Content="[Topology]: (Output/Existence) validation"/>',
        '                            <DataGrid Grid.Row="5" Name="NwTopology"',
        '                                      ScrollViewer.CanContentScroll="True"',
        '                                      ScrollViewer.IsDeferredScrollingEnabled="True"',
        '                                      ScrollViewer.HorizontalScrollBarVisibility="Visible">',
        '                                <DataGrid.Columns>',
        ...
        '                                                    <Button  Grid.Column="2" Name="DsApplyCustomSettings" Content="Apply"/>',
        '                                                </Grid>',
        ...
        '                                                    <Button  Grid.Column="2" Name="DsApplyPostConfig" Content="Apply"/>',
        '                                                </Grid>',
        ...
        '                                                    <Button  Grid.Column="2" Name="DsApplyDSKey" Content="Apply"/>',
        '                                                </Grid>',
    ...
    "[Config.IIS]" | Write-Comment -I 4 | Set-Clipboard
