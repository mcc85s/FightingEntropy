...
\\  Date       : 2024-01-21 15:22:58                                                                  //
 \\==================================================================================================// 
    ...
    TODO       : AKA "System Control Extension Utility"
                 ...
                 [+] 2023_0817-(Get-ViperBomb v2023.8.0)
                     https://youtu.be/EcIJ9l9NK8Q  (0h 4m 23s)
.Example
#>
...
Function Get-ViperBomb
{
    ...
    Param(
    [ValidateSet(0,1,2)]
    [Parameter(ParameterSetName=0)][UInt32]$Mode=1)
    ...
    Class ViperBombXaml
    {
        ...
        '                                        ImageSource="C:\ProgramData\Secure Digits Plus LLC\FightingEntropy\2023.12.0\Graphics\background.jpg"/>',
        '                        </Grid.Background>',
        '                        <Grid.RowDefinitions>',
        '                            <RowDefinition Height="*"/>',
        '                        </Grid.RowDefinitions>',
        '                        <Image Grid.Row="0"',
        '                               Source="C:\ProgramData\Secure Digits Plus LLC\FightingEntropy\2023.12.0\Graphics\banner.png"/>',
        '                    </Grid>',
        '                    <DataGrid Grid.Row="2"',
        '                              Name="Module">',
        '                        <DataGrid.RowStyle>',
        ...
        '                                    </Grid.ColumnDefinitions>',
        '                                    <Button Grid.Column="0"',
        '                                            Name="SettingProfileApply"',
        '                                            Content="Apply"',
        '                                            IsEnabled="False"/>',
        '                                    <Button Grid.Column="1"',
        '                                            Name="SettingProfileReset"',
        '                                            Content="Reset"',
        '                                            IsEnabled="False"/>',
        '                                </Grid>',
        '                            </Grid>',
