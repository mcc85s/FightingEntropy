...
Function Get-ViperBomb
{
    ...
    Class ViperBombXaml
    {
        ...
        '                                        ImageSource="C:\ProgramData\Secure Digits Plus LLC\FightingEntropy\2024.1.0\Graphics\background.jpg"/>',
        '                        </Grid.Background>',
        '                        <Grid.RowDefinitions>',
        '                            <RowDefinition Height="*"/>',
        '                        </Grid.RowDefinitions>',
        '                        <Image Grid.Row="0"',
        '                               Source="C:\ProgramData\Secure Digits Plus LLC\FightingEntropy\2024.1.0\Graphics\banner.png"/>',
        '                    </Grid>',
        '                    <DataGrid Grid.Row="2"',
        '                              Name="Module">',
        '                        <DataGrid.RowStyle>',
