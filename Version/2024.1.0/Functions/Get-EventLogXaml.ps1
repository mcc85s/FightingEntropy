...
Function Get-EventLogXaml
{
    Class EventLogXaml
    {
        ...
        '        Title="[FightingEntropy]://Event Log Utility"',
        '        Width="1100"',
        '        Height="650"',
        ...
        '                               Content="[Main]:"/>',
        '                        <ComboBox Grid.Column="1"',
        '                                  Name="LogMainProperty" SelectedIndex="1">',
        ...
        '                                                Width="100"/>',
        '                            <DataGridTextColumn Header="Isolation"',
        '                                                Binding="{Binding LogIsolation}"',
        '                                                Width="100"/>',
        '                            <DataGridTextColumn Header="Enabled"',
        '                                                Binding="{Binding IsEnabled}"',
        '                                                Width="50"/>',
        '                            <DataGridTextColumn Header="Classic"',
        '                                                Binding="{Binding IsClassicLog}"',
        '                                                Width="50"/>',
        '                        </DataGrid.Columns>',
        '                    </DataGrid>',
        '                    <Grid Grid.Row="2">',
        ...
        '                        </ComboBox>',
        '                        <TextBox Grid.Column="2"',
        '                                 Name="LogOutputFilter"/>',
        '                        <Button Grid.Column="3"',
        '                                Name="LogOutputRefresh"',
        '                                Content="Refresh"/>',
        '                    </Grid>',
        '                    <DataGrid Grid.Row="4"',
        '                              Name="LogOutputResult">',
        '                        <DataGrid.Columns>',
        '                            <DataGridTextColumn Header="Index"',
        '                                                Binding="{Binding Index}"',
        '                                                Width="50"/>',
