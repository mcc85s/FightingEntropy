<#
    ...
    //¯¯\\__//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\\___    
    \\__//¯¯¯ [FightingEntropy(π)][2023.8.0]: 2024-01-20 00:33:59                                            ___//¯¯\\   
...
Function FightingEntropy.Module
{
    ...
    Class ManifestFileEntry
    {
        ...
        Download()
        {
            Try
            {
                $xContent     = Invoke-WebRequest $This.Source -UseBasicParsing -OperationTimeoutSeconds 5 | % Content
    ...
    Class InstallController
    {
        ...
        [Object[]] GetManifestList([String]$Name)
        {
            $List = Switch ($Name)
            {
                ...
                Function
                {
                    ...
                    ("Get-FEModule.ps1"                , "F4F8F8BC7F6E6DE118B1B94EB67A927E3CD4BED1D91A767469B00E0DF489E509") ,
        ...
        [String] ToString()
        {
            Return "<FightingEntropy.Module.Installer[Controller]>"
        }
    }
...
/¯¯¯¯¯¯¯¯¯¯¯                                                                                                             
    __________________________________________________________________________________________
    | Michael C. Cook Sr. | Security Engineer | Secure Digits Plus LLC | 2024-01-20 00:33:59 |
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯               ___________/
