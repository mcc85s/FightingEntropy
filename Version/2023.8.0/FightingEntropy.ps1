<#
    ...
    //¯¯\\__//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\\___    
    \\__//¯¯¯ [FightingEntropy(π)][2023.8.0]: 2024-01-20 00:27:08                                            ___//¯¯\\   
...
Function FightingEntropy.Module
{
    ...
    Class ManifestFileEntry
    {
        ...
        Download()
        {
            ...
            {
                $Splat        = $This.Splat()
                $xContent     = Invoke-WebRequest @Splat | % Content
...
/¯¯¯¯¯¯¯¯¯¯¯                                                                                                             
    __________________________________________________________________________________________
    | Michael C. Cook Sr. | Security Engineer | Secure Digits Plus LLC | 2024-01-20 00:27:08 |
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯               ___________/
