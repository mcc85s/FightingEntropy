...
\\  Date       : 2023-08-08 15:56:14                                                                  //
 \\==================================================================================================// 

    FileName   : Write-Theme.ps1
    Solution   : [FightingEntropy()][2023.8.0]
    Purpose    : The lifeblood of [FightingEntropy()]...
                 With it...?
                 You can stylize the hell out a PowerShell command prompt console.
        ...
        ThemeStack([String]$Type)
        {
            ...
            Switch -Regex ($Type)
            {
                ...
                ^Flag$
                {
                    ...
                    $Hash = @{ }
                    "[==[ Dynamically Engineered Digital Security ]_/",
                    "[_[ Application Development - Virtualization ]_/",
                    "[====_[ Network & Hardware Magistration ]======/",
                    "----------------",
                    "  Fighting ($([Char]960))  ",
                    "     Entropy    ",
                    "----------------",
