...
Function Invoke-cimdb
{
    ...
    Class cimdbXaml
    {
        ...
        '                <Image Source="C:\ProgramData\Secure Digits Plus LLC\FightingEntropy\2023.8.0\Graphics\sdplogo.png"/>',
        '            </Button>',
        ...
        '                                            <Image Source="C:\ProgramData\Secure Digits Plus LLC\FightingEntropy\2023.8.0\Control\up.png"/>',
        '                                        </Button>',
        '                                        <Button Grid.Row="4"',
        '                                                    Name="EditClientPhoneMoveDown">',
        '                                            <Image Source="C:\ProgramData\Secure Digits Plus LLC\FightingEntropy\2023.8.0\Control\down.png"/>',
        '                                        </Button>',
        '                                    </Grid>',
        '                                </Grid>',
        '                            </Grid>',
