...
Function Get-MDTModule
{
    ...
    Class MDTStatus
    {
        ...
        [Object]              $MDT = @{ 
            ...
            Resource               = "https://download.microsoft.com/download/3/3/9/339BE62D-B4B8-4956-B58D-73C4685FC492/MicrosoftDeploymentToolkit_x{0}.msi" -f $This.Arch()
            Path                   = "{0}\Tools\MDT"
            File                   = "MicrosoftDeploymentToolkit_x{0}.msi" -f $This.Arch()
